...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_croppie__ = __webpack_require__(19);
...
var Account = function Account() {
    ...
    var createEmailAndPhone = function createEmailAndPhone() {

        var email_select = "";
        var email_list = accountData.email.map(function (data, index) {
            status = "";
            if (data.is_primary) {
        ...
        var phone_select = "";
        var phone_list = accountData.phone.map(function (data, index) {
            status = "";
            if (data.is_primary) {
                status = '<span class="badge badge-pill badge-primary d-flex justify-content-center align-items-center">Primary</span>';
            }
    ...
    var deleteEmail = function deleteEmail(el) {
    ...
    var deletePhone = function deletePhone(el) {
        var phone = $(el).attr('phone');
        var index = $(el).attr('index');
        $.ajax({
    ...
    var updateUsername = function updateUsername() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn_update_username"));
        $.ajax({
            ...
            success: function success(res) {
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_update_username"));
                toastr["success"]("Success");
            },
            error: function error(res) {}
        });
    ...
    var updateName = function updateName() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn-update-profile"));
        $.ajax({
            ...
            success: function success(res) {
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn-update-profile"));
                location.reload();
            },
            error: function error(res) {}
        });
    ...
    var addEmail = function addEmail() {
        var email = $("input[name='add-email']").val();
        $.ajax({
    ...
    var changePrimaryEmail = function changePrimaryEmail() {
    ...
    var addPhone = function addPhone() {
        var phone = $("input[name='add-phone']").val();
        $.ajax({
    ...
    var changePrimaryPhone = function changePrimaryPhone() {
