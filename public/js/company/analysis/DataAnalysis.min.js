...
var createDesc = __webpack_require__(238);
...
var SRC = __webpack_require__(267)('src');
...
if (__webpack_require__(23)) {
  ...
  var fails = __webpack_require__(15);
  var $export = __webpack_require__(2);
  var $typed = __webpack_require__(302);
  var $buffer = __webpack_require__(334);
  var ctx = __webpack_require__(171);
  var anInstance = __webpack_require__(273);
  var propertyDesc = __webpack_require__(238);
  var hide = __webpack_require__(166);
  var redefineAll = __webpack_require__(274);
  var toInteger = __webpack_require__(183);
  var toLength = __webpack_require__(24);
  var toIndex = __webpack_require__(363);
  ...
  var createArrayIncludes = __webpack_require__(290);
  ...
  var arrayCopyWithin = __webpack_require__(354);
  var $DP = __webpack_require__(22);
...
var defined = __webpack_require__(182);
var fails = __webpack_require__(15);
var spaces = __webpack_require__(317);
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
var setToStringTag = __webpack_require__(276);
var getPrototypeOf = __webpack_require__(169);
var ITERATOR = __webpack_require__(20)('iterator');
...
__webpack_require__(166)(IteratorPrototype, __webpack_require__(20)('iterator'), function () { return this; });
...
var redefine = __webpack_require__(167);
var redefineAll = __webpack_require__(274);
var meta = __webpack_require__(239);
...
module.exports = __webpack_require__(240) || !__webpack_require__(15)(function () {
  var K = Math.random();
...
var core = __webpack_require__(29);
var LIBRARY = __webpack_require__(240);
var wksExt = __webpack_require__(341);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(171)(Function.call, __webpack_require__(168).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var isObject = __webpack_require__(14);
var setPrototypeOf = __webpack_require__(315).set;
...
var cel = __webpack_require__(309);
var global = __webpack_require__(13);
...
var isNode = __webpack_require__(178)(process) == 'process';
...
var ws = __webpack_require__(317);
var hex = /^[-+]?0[xX]/;
...
var anObject = __webpack_require__(11);
var isObject = __webpack_require__(14);
var newPromiseCapability = __webpack_require__(333);
...
var anInstance = __webpack_require__(273);
var forOf = __webpack_require__(242);
var $iterDefine = __webpack_require__(293);
var step = __webpack_require__(330);
var setSpecies = __webpack_require__(272);
var DESCRIPTORS = __webpack_require__(23);
...
// 23.2 Set Objects
module.exports = __webpack_require__(301)(SET, function (get) {
...
var weak = __webpack_require__(362);
var isObject = __webpack_require__(14);
var fails = __webpack_require__(15);
var validate = __webpack_require__(278);
...
var $WeakMap = module.exports = __webpack_require__(301)(WEAK_MAP, wrapper, methods, weak, true, true);
...
var redefineAll = __webpack_require__(274);
var getWeak = __webpack_require__(239).getWeak;
var anObject = __webpack_require__(11);
var isObject = __webpack_require__(14);
var anInstance = __webpack_require__(273);
var forOf = __webpack_require__(242);
...
var getKeys = __webpack_require__(234);
var toIObject = __webpack_require__(30);
var isEnum = __webpack_require__(286).f;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_js__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_core_js__);
...
var DataAnalysis = function DataAnalysis() {
    ...
    var bindElement = function bindElement() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__utility__["b" /* addEventValidate */])(validateInput.day);
        Object(__WEBPACK_IMPORTED_MODULE_1__utility__["b" /* addEventValidate */])(validateInput.month);
        Object(__WEBPACK_IMPORTED_MODULE_1__utility__["b" /* addEventValidate */])(validateInput.year);
        ...
        $("#form_upload").on('submit', function (e) {
            e.preventDefault();
            __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn_submit_upload"));
            $.ajax({
                ...
                success: function success(data, textStatus, xhr) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_submit_upload"));
    ...
    var updateListDatasource = function updateListDatasource() {
        $("#datasource").empty();
        var html = "";
        var opt = "<option value=''>--Select datasource--</option>";
        opt += "<optgroup label=\"Web services\">";

        listDatasource.webservices.map(function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(data, index) {
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
        ...
        listDatasource.iot.map(function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(data, index) {
    ...
    var getDwname = function getDwname(type, service_id) {
        var data = null;
        if (type == "web_services") {
            data = listDatasource.webservices.filter(function (_data) {
                return _data.webservice_id == service_id;
            });
        } else {
            data = listDatasource.iot.filter(function (_data) {
    ...
    var getDatasource = function getDatasource() {
        $.ajax({
            ...
            success: function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(res, textStatus, xhr) {
    ...
    var createListValue = function createListValue() {
        var pathObject = Object(__WEBPACK_IMPORTED_MODULE_1__utility__["g" /* getFlatObject */])(listValue[0]);
        var key = __WEBPACK_IMPORTED_MODULE_2_core_js__["Object"].keys(pathObject);
        var html = "";
    ...
    var showValues = function showValues() {
        getLabelSelectGroup();
        var datasource = getDwname(state.selectedTypeDatasource, $("#datasource").val());
        var url = "";
        var param = {};
    ...
    var getLabelSelectGroup = function getLabelSelectGroup() {
        var selected = $("#datasource").find(":selected");
        state.selectedTypeDatasource = selected.closest('optgroup').attr('label').toLowerCase().replace(' ', '_');
    };

    var addDataAnalysis = function addDataAnalysis() {
        if (Object(__WEBPACK_IMPORTED_MODULE_1__utility__["d" /* checkError */])(validateInput.create)) {
            if (state.typeTime === "Day") {
                Object(__WEBPACK_IMPORTED_MODULE_1__utility__["d" /* checkError */])(validateInput.day);
            } else if (state.typeTime === "Month") {
                Object(__WEBPACK_IMPORTED_MODULE_1__utility__["d" /* checkError */])(validateInput.month);
            } else if (state.typeTime === "Year") {
                Object(__WEBPACK_IMPORTED_MODULE_1__utility__["d" /* checkError */])(validateInput.year);
            }
            return;
        }

        getLabelSelectGroup();
        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn_save"));
        var data_name = $("#data_name").val();
        var service_id = $("#datasource").val();
        var datasource = getDwname(state.selectedTypeDatasource, service_id);
        ...
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_save"));
    ...
    var updateDatatableData = function updateDatatableData() {
        ...
        dataList.map(function (item, index) {
            ...
            ret[3] = "<center>\n                            <button type=\"button\" class=\"btn btn-primary btn-sm btn-lookup\" index=" + index + " data-toggle=\"tooltip\"\n                                data-placement=\"top\" title=\"Look\">\n                                <i class=\"far fa-eye\"></i>\n                            </button>\n                            <button type=\"button\" class=\"btn btn-success btn-sm btn-download btn-download-csv\" typeFile=\"csv\" index=" + index + " data-toggle=\"tooltip\"\n                                data-placement=\"top\" title=\"Download CSV\">\n                                <i class=\"fas fa-table\"></i>\n                            </button>\n                            <button type=\"button\" class=\"btn btn-info btn-sm btn-download btn-download-arff\" typeFile=\"arff\" index=" + index + " data-toggle=\"tooltip\"\n                            data-placement=\"top\" title=\"Download arff\">\n                            <i class=\"fas fa-crow\"></i>\n                            </button>\n                            <button type=\"button\" class=\"btn btn-danger btn-sm btn-delete\" index=" + index + "  data-toggle=\"tooltip\"\n                                data-placement=\"top\" title=\"Delete\">\n                                <i class=\"fas fa-trash-alt\"></i>\n                            </button>\n                          </center>";
            Datatable.push(ret);
        });

        if (Datatable.length > 0) elDataTable.fnAddData(Datatable);

        $('[data-toggle="tooltip"]').tooltip();
    };

    var onBtnDownloadClick = function onBtnDownloadClick(index, typeFile) {
        var file = "";
        var fileZip = "";
        if (typeFile === "arff") {
            file = dataList[index].path_file;
            if (file) fileZip = file.replace(".arff", ".zip");
        } else if (typeFile === "csv") {
            file = dataList[index].path_file_csv;
            if (file) fileZip = file.replace(".csv", ".zip");
        }
        ...
        $.ajax({
            ...
            url: END_POINT + "analysis/download/" + file,
            method: "GET",
            xhrFields: {
                responseType: 'blob'
            },
    ...
    var onBtnLookupClick = function onBtnLookupClick(key) {
        if (modalLookup === null) {
    ...
    var getDataById = function getDataById(data_id) {
    ...
    var onBtnEditClick = function onBtnEditClick(key) {
        if (modalEdit === null) {
    ...
    var onBtnSubmitEditClick = function onBtnSubmitEditClick(key) {
    ...
    var onBtnDeleteClick = function onBtnDeleteClick(key) {
        if (modalDelete === null) {
    ...
    var onBtnSubmitDeleteClick = function onBtnSubmitDeleteClick(key) {
        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn_submit_delete"));
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                Object(__WEBPACK_IMPORTED_MODULE_1__utility__["c" /* checkAuthRes */])(xhr);
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_submit_delete"));
    ...
    var initialDatatable = function initialDatatable() {
        ...
        $("#example").on('click', '.btn-lookup', function () {
            onBtnLookupClick($(this).attr('index'));
        });

        $("#example").on('click', '.btn-download', function () {
            onBtnDownloadClick($(this).attr('index'), $(this).attr('typeFile'));
        });
...
$export($export.S + $export.F * !__webpack_require__(23), 'Object', { defineProperties: __webpack_require__(343) });
...
var isObject = __webpack_require__(14);
var meta = __webpack_require__(239).onFreeze;
...
var $export = __webpack_require__(2);
$export($export.S, 'Object', { is: __webpack_require__(431) });
...
if (test + '' != '[object z]') {
  __webpack_require__(167)(Object.prototype, 'toString', function toString() {
...
var $export = __webpack_require__(2);
var $parseFloat = __webpack_require__(347);
...
var BROKEN_COF = cof(__webpack_require__(235)(proto)) == NUMBER;
...
if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
  ...
  __webpack_require__(167)(global, NUMBER, $Number);
}
...
// 20.2.2.14 Math.expm1(x)
var $export = __webpack_require__(2);
var $expm1 = __webpack_require__(321);
...
$export($export.S, 'Math', { fround: __webpack_require__(351) });
...
$export($export.S, 'Math', { sign: __webpack_require__(320) });
...
var $export = __webpack_require__(2);
var toLength = __webpack_require__(24);
var context = __webpack_require__(323);
...
$export($export.P, 'String', {
  ...
  repeat: __webpack_require__(319)
});
...
__webpack_require__(170)('anchor', function (createHTML) {
...
__webpack_require__(170)('big', function (createHTML) {
  return function big() {
...
__webpack_require__(170)('blink', function (createHTML) {
...
__webpack_require__(170)('bold', function (createHTML) {
...
__webpack_require__(170)('fixed', function (createHTML) {
...
__webpack_require__(170)('fontcolor', function (createHTML) {
...
__webpack_require__(170)('fontsize', function (createHTML) {
...
__webpack_require__(170)('italics', function (createHTML) {
...
__webpack_require__(170)('link', function (createHTML) {
...
__webpack_require__(170)('small', function (createHTML) {
...
__webpack_require__(170)('strike', function (createHTML) {
...
__webpack_require__(170)('sub', function (createHTML) {
  return function sub() {
...
__webpack_require__(170)('sup', function (createHTML) {
  return function sup() {
...
var $export = __webpack_require__(2);
var toISOString = __webpack_require__(493);
...
if (new Date(NaN) + '' != INVALID_DATE) {
  __webpack_require__(167)(DateProto, TO_STRING, function toString() {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(166)(proto, TO_PRIMITIVE, __webpack_require__(496));
...
$export($export.P + $export.F * (__webpack_require__(285) != Object || !__webpack_require__(179)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(2);
var $indexOf = __webpack_require__(290)(false);
var $native = [].indexOf;
...
var gOPN = __webpack_require__(269).f;
var isRegExp = __webpack_require__(295);
var $flags = __webpack_require__(297);
...
if (__webpack_require__(23) && (!CORRECT_NEW || __webpack_require__(15)(function () {
  ...
  __webpack_require__(167)(global, 'RegExp', $RegExp);
}
...
var define = function (fn) {
  __webpack_require__(167)(RegExp.prototype, TO_STRING, fn, true);
};
...
var newPromiseCapabilityModule = __webpack_require__(333);
var perform = __webpack_require__(356);
var userAgent = __webpack_require__(300);
var promiseResolve = __webpack_require__(357);
var PROMISE = 'Promise';
var TypeError = global.TypeError;
var process = global.process;
...
__webpack_require__(276)($Promise, PROMISE);
...
$export($export.S + $export.F * !(USE_NATIVE && __webpack_require__(296)(function (iter) {
...
__webpack_require__(301)(WEAK_SET, function (get) {
...
var $export = __webpack_require__(2);
var getProto = __webpack_require__(169);
var anObject = __webpack_require__(11);
...
var $export = __webpack_require__(2);
var setProto = __webpack_require__(315);
...
var $export = __webpack_require__(2);
var $includes = __webpack_require__(290)(true);
...
var $export = __webpack_require__(2);
var flattenIntoArray = __webpack_require__(364);
var toObject = __webpack_require__(25);
var toLength = __webpack_require__(24);
var aFunction = __webpack_require__(26);
...
__webpack_require__(241)('flatMap');
...
__webpack_require__(241)('flatten');
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(2);
var $pad = __webpack_require__(365);
var userAgent = __webpack_require__(300);
...
var toLength = __webpack_require__(24);
var isRegExp = __webpack_require__(295);
var getFlags = __webpack_require__(297);
...
__webpack_require__(310)('asyncIterator');
...
__webpack_require__(310)('observable');
...
__webpack_require__(23) && $export($export.P + __webpack_require__(303), 'Object', {
...
__webpack_require__(304)('WeakMap');
...
__webpack_require__(304)('WeakSet');
...
__webpack_require__(305)('WeakMap');
...
__webpack_require__(305)('WeakSet');
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(2);
var scale = __webpack_require__(369);
var fround = __webpack_require__(351);
...
$export($export.S, 'Math', { scale: __webpack_require__(369) });
...
var metadata = __webpack_require__(237);
var anObject = __webpack_require__(11);
...
var $export = __webpack_require__(2);
var $task = __webpack_require__(331);
...
var aFunction = __webpack_require__(26);
var forOf = __webpack_require__(242);
var isIterable = __webpack_require__(370);
var $iterCreate = __webpack_require__(294);
var step = __webpack_require__(330);
var isObject = __webpack_require__(14);
var toIObject = __webpack_require__(30);
...
// Placeholder
__webpack_require__(29)._ = path._ = path._ || {};

$export($export.P + $export.F, 'Function', { part: __webpack_require__(371) });
...
$export($export.S + $export.F, 'Object', { classof: __webpack_require__(270) });
...
var $export = __webpack_require__(2);
var define = __webpack_require__(373);
...
__webpack_require__(293)(Number, 'Number', function (iterated) {
  this._l = +iterated;
  this._i = 0;
}, function () {
  var i = this._i++;
...
var $export = __webpack_require__(2);
var $re = __webpack_require__(336)(/&(?:amp|lt|gt|quot|apos);/g, {
  '&amp;': '&',
  '&lt;': '<',
  '&gt;': '>',
  '&quot;': '"',
