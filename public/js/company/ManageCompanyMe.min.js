...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_croppie__ = __webpack_require__(308);
...
var ManageCompanyMe = function ManageCompanyMe() {
    _classCallCheck(this, ManageCompanyMe);
    ...
    var createSelectProvices = function createSelectProvices(value) {
    ...
    var getProvinces = function getProvinces(value) {
        $.ajax({
    ...
    var createSelectAmphures = function createSelectAmphures(amphure_id) {
    ...
    var getAmphuresByProvince = function getAmphuresByProvince(province_id, amphure_id) {
        $.ajax({
    ...
    var createSelectdistrict = function createSelectdistrict(district_id) {
    ...
    var getDistrictsByAmphures = function getDistrictsByAmphures(province_id, amphure_id, district_id) {
        $.ajax({
    ...
    var getCompanyMe = function getCompanyMe() {
        $.ajax({
    ...
    var updateCompany = function updateCompany() {
        if (Object(__WEBPACK_IMPORTED_MODULE_1__utility__["d" /* checkError */])(validateInput.company)) return;
        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn_submit_edit_company"));
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                Object(__WEBPACK_IMPORTED_MODULE_1__utility__["c" /* checkAuthRes */])(xhr);
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_submit_edit_company"));
                location.reload();
            },
            error: function error(res) {
                __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn_submit_edit_company"));
    ...
    var bindElement = function bindElement() {
        ...
        $('#imageUploadForm').on('submit', function (e) {
            __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].set($("#btn-crop-save"));
            e.preventDefault();
            uploadCrop.croppie('result', {
                ...
                $.ajax({
                    ...
                    success: function success(res, textStatus, xhr) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_1__utility__["a" /* LOADING */].reset($("#btn-crop-save"));
                        location.reload();
                    },
        ...
        $("#district_edit").change(function () {
            ...
            if ($(this).val() != "") {
                var district = districts.filter(function (data) {
                    return data.district_id === $(_this).val();
                });
    ...
    this.initAndRun = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__utility__["b" /* addEventValidate */])(validateInput.company);
    };
};

$(document).ready(function () {
    var m = new ManageCompanyMe();
    m.initAndRun();
});
