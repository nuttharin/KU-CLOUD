...
var staticDataTable = function staticDataTable() {
    ...
    var staticDataTableCompany = null;
    var staticDataTableCustomer = null;
    var staticListCompany = null;
    var staticListCustomer = null;
    var modalEdit = null;
    ...
    var addStaticDashboard = function addStaticDashboard() {
        ...
        if (state.tab_selected === "company-tab") {
            ...
            if (Object(__WEBPACK_IMPORTED_MODULE_0__utility__["d" /* checkError */])(validateInput.createForCustomer)) {
                return;
            }
            param['name'] = static_name;
            param['desc'] = desc;
        ...
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                ...
                if (state.tab_selected == "company-tab") {
                    _this.showLastestDatatableCompany();
                } else {
                    _this.showLastestDatatableCustomer();
                }
            },
    ...
    var updateDatatableData = function updateDatatableData() {
        ...
        if (Datatable.length > 0) staticDataTableCompany.fnAddData(Datatable);
    ...
    var updateDatatableDataCustomer = function updateDatatableDataCustomer() {
        var Datatable = [];
        ...
        if (Datatable.length > 0) staticDataTableCustomer.fnAddData(Datatable);
    ...
    var onBtnLookupClick = function onBtnLookupClick(key, index) {
        if (state.tab_selected === "company-tab") {
    ...
    var createUserList = function createUserList() {
        var elCustomer = $("select[name='customer']");
        var html = '<option value="">--Select customer--</option>';
        usernameList.map(function (_user) {
            html += "<option value=\"" + _user.user_id + "\">" + _user.username + "</option>";
        });
        elCustomer.html(html);
    };

    var getUsernameInCompany = function getUsernameInCompany() {
        $.ajax({
    ...
    this.showLastestDatatableCustomer = function () {
        showDatatableLoadingStatus(true);
        $.ajax({
            url: END_POINT + API.getStaticDashboardCustomer,
            headers: {
    ...
    this.showLastestDatatableCompany = function () {
        showDatatableLoadingStatus(true);
        $.ajax({
