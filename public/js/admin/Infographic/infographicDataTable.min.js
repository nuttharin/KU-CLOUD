...
var infoDataTable = function infoDataTable() {
    ...
    var addInfoDashboard = function addInfoDashboard() {
        __WEBPACK_IMPORTED_MODULE_0__utility__["b" /* LOADING */].set($("#btn-save-add-info"));
        ...
        $.ajax({
            ...
            success: function success(res) {
                console.log("success");
                $("#addInfo").modal('hide');
                __WEBPACK_IMPORTED_MODULE_0__utility__["b" /* LOADING */].reset($("#btn-save-add-info"));
    ...
    var onBtnSubmitDeleteClick = function onBtnSubmitDeleteClick(key) {
        __WEBPACK_IMPORTED_MODULE_0__utility__["b" /* LOADING */].set($("#btn-submit-delete"));
        $.ajax({
            ...
            success: function success(res) {
                __WEBPACK_IMPORTED_MODULE_0__utility__["b" /* LOADING */].reset($("#btn-submit-delete"));
