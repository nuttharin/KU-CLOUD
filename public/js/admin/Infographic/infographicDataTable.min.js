...
var END_POINT_WED = 'http://localhost:8000/';
...
var infoDataTable = function infoDataTable() {
    ...
    var addInfoDashboard = function addInfoDashboard() {
        ...
        $.ajax({
            url: END_POINT + "admin/infographic/create",
            method: 'POST',
            data: {
                name: info_name
            },
    ...
    var onBtnLookupClick = function onBtnLookupClick(key) {
        window.location.href = END_POINT_WED + "Admin/Infographic/" + key;
    };
    ...
    var onBtnSubmitEditClick = function onBtnSubmitEditClick(key) {
        ...
        $.ajax({
            url: END_POINT + 'admin/infographic/update',
            method: 'PUT',
            data: {
    ...
    var onBtnSubmitDeleteClick = function onBtnSubmitDeleteClick(key) {
        ...
        $.ajax({
            url: END_POINT + "admin/infographic/delete",
            method: "DELETE",
            data: {
                info_id: infoList[key].info_id
            },
    ...
    this.showLastestDatatable = function () {
        ...
        $.ajax({
            url: END_POINT + "admin/infographic/getInfoByUserID",
            success: function success(res) {
