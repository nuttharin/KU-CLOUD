...
var infoDataTable = function infoDataTable() {
    var _this = this;

    _classCallCheck(this, infoDataTable);

    var _infoDataTable = null;
    var infoList = null;
    var modalEdit = null;
    ...
    var bindElement = function bindElement() {
        $("#btn-add-info").click(function () {
            ...
            $.ajax({
                ...
                success: function success(result, textStatus, xhr) {
                    ...
                    $('#create_customer_email').empty();
                    $.each(customerList, function (key, value) {
                        if (customerList[key].company_id != 1) {
                            $('#create_customer_email').append($("<option></option>").attr("value", value.user_id).text(value.email_user));
                        }
                    });
                },
        ...
        $("#btn-save-add-info").click(function () {
            ...
            if (Object(__WEBPACK_IMPORTED_MODULE_0__utility__["d" /* checkError */])(validateInput.info)) return;
            addInfoDashboard();
        });
    ...
    var addInfoDashboard = function addInfoDashboard() {
        __WEBPACK_IMPORTED_MODULE_0__utility__["a" /* LOADING */].set($("#btn-save-add-info"));
        var info_name = $("#info-name").val();
        var user_id = null;
        if ($("#create_customer_email").val() != null) {
            user_id = $("#create_customer_email").val();
        }
        ...
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                ...
                console.log("success");
                $("#addInfo").modal('hide');
                __WEBPACK_IMPORTED_MODULE_0__utility__["a" /* LOADING */].reset($("#btn-save-add-info"));
                _this.showLastestDatatable();
                $("#addInfo").find("input,textarea,select").val('').end();
            },
    ...
    var updateDatatableData = function updateDatatableData() {
        ...
        if (Datatable.length > 0) {
            _infoDataTable.fnAddData(Datatable);
        }
    ...
    var onBtnLookupClick = function onBtnLookupClick(key, keyfilename) {
    ...
    var onBtnEditClick = function onBtnEditClick(key) {
        ...
        if (typeUser == "COMPANY") {
            $("#edit_info_name").val(selectList[key].name);
            $("#edit_info_id").val(selectList[key].info_id);
        } else {
            $("#edit_info_name").val(infoList[key].name);
            $("#edit_info_id").val(infoList[key].info_id);
        }
    ...
    var onBtnDeleteClick = function onBtnDeleteClick(key) {
        ...
        if (typeUser == "COMPANY") {
            $("#delete-info-name").html(selectList[key].name);
            $("#delete-info-id").val(selectList[key].info_id);
        } else {
            $("#delete-info-name").html(infoList[key].name);
            $("#delete-info-id").val(infoList[key].info_id);
        }
    ...
    var initialDatatable = function initialDatatable() {
        if (_infoDataTable !== null) {
            return false;
        }
        _infoDataTable = $('#example').dataTable({});
    };
    ...
    this.initialAndRun = function () {
        ...
        initialDatatable();
        _this.showLastestDatatable();
        Object(__WEBPACK_IMPORTED_MODULE_0__utility__["b" /* addEventValidate */])(validateInput.info);
    };
    ...
    this.showLastestDatatable = function () {
        ...
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                ...
                if (typeUser == "COMPANY") {
                    if ($("#company-tab").hasClass("active")) {
                        selectList = infoList.company;
                    } else {
                        selectList = infoList.customer;
                    }
