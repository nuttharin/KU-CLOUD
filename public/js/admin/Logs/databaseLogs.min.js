...
var DatabaseLogs = function DatabaseLogs() {
    ...
    var updateDatatableData = function updateDatatableData(folder) {
        var Datatable = [];
    ...
    var onlookClick = function onlookClick(index) {
        ...
        if (datatableFileLogObject === null) {
            ...
            $('#table-file-log').on('click', '.btn-download-file', function () {
                onBtnDownloadFileClick($(this).attr('index'));
            });
    ...
    var onBtnDownloadFolderClick = function onBtnDownloadFolderClick(index) {
        $('.progress-bar').css({
            width: 0 + '%'
        });
        ...
        $.ajax({
            ...
            url: END_POINT + 'admin/database/log/folder/download',
            method: 'POST',
            data: {
                folder: folderLogList[index].folder_log
            },
            xhrFields: {
                responseType: 'blob'
            },
            success: function success(res, textStatus, xhr) {
                ...
                if (xhr.status != 204) {
                    ...
                    a.href = url;
                    a.download = folderLogList[index].folder_log + ".zip";
                    a.click();
    ...
    var onDeleteClick = function onDeleteClick(index) {
        swal({
            title: "Are you sure?",
    ...
    var onBtnDownloadFileClick = function onBtnDownloadFileClick(index) {
        $.ajax({
            url: END_POINT + 'admin/database/log/file/download',
            method: 'POST',
            data: {
                folder: fileLogList[index].folder,
                file: fileLogList[index].file
            },
            success: function success(res, textStatus, xhr) {
                Object(__WEBPACK_IMPORTED_MODULE_0__utility__["c" /* checkAuthRes */])(xhr);
                var binaryData = [];
                ...
                a.href = url;
                a.download = fileLogList[index].folder + '_' + fileLogList[index].file;
                a.click();
                window.URL.revokeObjectURL(url);
            },
    ...
    var deleteFileLogByFolder = function deleteFileLogByFolder(folder) {
        $.ajax({
    ...
    var deleteFileLog = function deleteFileLog(folder, file) {
        $.ajax({
    ...
    var updateDatatableFileLogViewer = function updateDatatableFileLogViewer() {
        ...
        $("#btn-delete-file").unbind().click(function () {
            swal({
                title: "Are you sure?",
                text: 'to delete log file : ' + filelogSelect.file,
                icon: "warning",
                buttons: true,
                dangerMode: true
            }).then(function (willDelete) {
    ...
    var getFileLogByFolder = function getFileLogByFolder(folder_log) {
        $("#modal-file-log .lds-roller").show();
        ...
        $.ajax({
            ...
            success: function success(res, textStatus, xhr) {
                ...
                $("#modal-file-log .lds-roller").hide();
            },
    ...
    var initialDatatable = function initialDatatable() {
        ...
        $('#datatable-folder-log').on('click', '.btn-download-folder', function () {
            onBtnDownloadFolderClick($(this).attr('index'));
        });
    ...
    var refreshDatatable = function refreshDatatable() {
