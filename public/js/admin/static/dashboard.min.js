...
/***/ "./resources/js/company/static/dashboard.min.js":
        ...
        this.selectWiContent = function () {
            ...
            switch (_this8.type) {
                ...
                case 'Gauges':
                    ...
                    unitId = _this8.itemId.replace("item-", "unit_");
                    return '\n                            <h2><span id="' + valueId + '">0</span> <span  id="' + unitId + '">' + _this8.unit + '</span></h2>\n                            <canvas id="' + _this8.widgetId + '"></canvas>\n                            ';
                case 'Map':
...
var MutiLine = function (_Widget) {
    ...
    function MutiLine(widget) {
        ...
        _this9.createMutiLine = function () {
            ...
            console.log(_this9.datasets);
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    datasets: Object(__WEBPACK_IMPORTED_MODULE_0__utility_js__["c" /* deepCopy */])(_this9.datasets)
                },
                options: options
            });
...
var Gauges = function (_Widget2) {
    ...
    function Gauges(widget) {
        ...
        _this11.limitMax = widget.limitMax;
        _this11.limitMin = widget.limitMin;
        _this11.unit = widget.unit;

        _this11.createGages = function () {
            var target = document.getElementById(_this11.widgetId); // your canvas element
            var gauge = new Gauge(target).setOptions(_this11.opts); // create sexy gauge!
            gauge.maxValue = _this11.limitMax; // set max gauge value
            gauge.setMinValue(0); // Prefer setter over gauge.minValue = 0
            gauge.animationSpeed = 32; // set animation speed (32 is default value)
            gauge.set(0); // set actual value
            _this11.gaugeWidget = gauge;
            _this11.updateData();
        };

        _this11.updateData = function () {
            var data = Math.floor(Math.random() * (100 - 1));
            $("#" + _this11.textId).html(data);
            _this11.gaugeWidget.set(data);
...
$(document).ready(function () {
    ...
    $('.grid-stack').on('gsresizestop', function (event, elem) {
        ...
        if (type === "Gauges") {
            ...
            var _width = el.find('.card-body').width();
            var _height = el.find('.card-body').height();
            var _panel = el.find('.card-body');
            var _id = $(_panel).find('canvas');
...
module.exports = __webpack_require__("./resources/js/company/static/dashboard.min.js");
