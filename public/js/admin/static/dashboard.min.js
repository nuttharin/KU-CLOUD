...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_file_saver__ = __webpack_require__(7);
...
var ModalEditWidget = function ModalEditWidget(widget) {
    ...
    this.findTitleWidget = function () {
        var el = $("#" + _this.widget.itemId).find('.title-widget');
        return el;
    };
};
...
var ModalEditWidgetMutiLine = function (_ModalEditWidget2) {
    ...
    function ModalEditWidgetMutiLine(widget) {
        ...
        var _this2 = _possibleConstructorReturn(this, (ModalEditWidgetMutiLine.__proto__ || Object.getPrototypeOf(ModalEditWidgetMutiLine)).call(this, widget));

        var inputHtml = '<div class="row" id="div-title">\n                            <div class="col-6">\n                                <lable>Title</label>\n                            <input type="text" class="form-control" id="edit-title"/>\n                            </div>\n                        </div>';

        var bindElement = function bindElement() {
            _this2.submitEditClick(onSubmit);
        };

        var onSubmit = function onSubmit() {
            var title = $("#edit-title").val();
            $(_this2.findTitleWidget()).html(title);
            _this2.widget.title_name = title;
            _this2.closeModalEdit();
        };
        ...
        _this2.initCreate = function () {
            _this2.createModalEdit(inputHtml, bindElement);
            bindElement();
            setElement();
        };
        return _this2;
...
var ModalEditWidgetGauges = function (_ModalEditWidget3) {
    ...
    function ModalEditWidgetGauges(widget) {
        ...
        var _this3 = _possibleConstructorReturn(this, (ModalEditWidgetGauges.__proto__ || Object.getPrototypeOf(ModalEditWidgetGauges)).call(this, widget));
        ...
        var onSubmit = function onSubmit() {
            ...
            var unitId = _this3.widget.itemId.replace("item-", "unit_");
            $(_this3.findTitleWidget()).html(title);
            $("#" + unitId).html(unit);
            _this3.widget.title_name = title;
            _this3.widget.unit = unit;
...
var ModalEditWidgetMap = function (_ModalEditWidget4) {
    ...
    function ModalEditWidgetMap(widget) {
        ...
        var _this4 = _possibleConstructorReturn(this, (ModalEditWidgetMap.__proto__ || Object.getPrototypeOf(ModalEditWidgetMap)).call(this, widget));
...
var ModalEditTextValue = function (_ModalEditWidget5) {
    ...
    function ModalEditTextValue(widget) {
        ...
        var _this5 = _possibleConstructorReturn(this, (ModalEditTextValue.__proto__ || Object.getPrototypeOf(ModalEditTextValue)).call(this, widget));
        ...
        var onSubmit = function onSubmit() {
            ...
            $("#" + _this5.widget.widgetId).next('span').html(unit);
            _this5.widget.title_name = title;
            _this5.widget.unit = unit;
...
var ModalEditTextLine = function (_ModalEditWidget6) {
    ...
    function ModalEditTextLine(widget) {
        ...
        var _this6 = _possibleConstructorReturn(this, (ModalEditTextLine.__proto__ || Object.getPrototypeOf(ModalEditTextLine)).call(this, widget));
        ...
        var onSubmit = function onSubmit() {
            var title = $("#edit-title").val();
            var unit = $("#edit-unit").val();
            var unitId = _this6.widget.itemId.replace("item-", "unit_");
...
var ModalEditWidgetTextBox = function (_ModalEditWidget7) {
    _inherits(ModalEditWidgetTextBox, _ModalEditWidget7);

    function ModalEditWidgetTextBox(widget) {
        _classCallCheck(this, ModalEditWidgetTextBox);

        var _this7 = _possibleConstructorReturn(this, (ModalEditWidgetTextBox.__proto__ || Object.getPrototypeOf(ModalEditWidgetTextBox)).call(this, widget));

        var inputHtml = '<div id = "edit-text-box" class="value_widget">\n                            <div class="row">\n                                <div class="col-6">\n                                    <label>Text</label>\n                                    <input type="text" id="edit-text-custom" class="form-control" />\n                                </div>\n                                <div class="col-6">\n                                    <label>Font Size (px)</label>\n                                    <input type="number" id="edit-font-size" class="form-control" />\n                                </div>\n                            </div>\n                        </div> ';
...
var Widget = function () {
    function Widget(widget) {
        ...
        this.updateLastUpdate = function () {
            ...
            if (time) {
                _this8.lastUpdate = new Date(time);
                $("#" + _this8.lastUpdateId).html(_this8.lastUpdate.toDateString() + " " + _this8.lastUpdate.toLocaleTimeString());
            } else {
                _this8.lastUpdate = new Date();
                $("#" + _this8.lastUpdateId).html(_this8.lastUpdate.toDateString() + " " + _this8.lastUpdate.toLocaleTimeString());
            }
        };
        ...
        var bindWidgetElement = function bindWidgetElement() {
            ...
            $(".btn-download").unbind().click(function () {
                ...
                var canvas = document.getElementById(widget.widgetId);

                canvas.toBlob(function (blob) {
                    __WEBPACK_IMPORTED_MODULE_1_file_saver___default()(blob, "image.jpg");
                });
            });
        };
        ...
        this.selectWiContent = function () {
            ...
            switch (_this8.type) {
                case 'MutiLine':
                    return '<canvas id="' + _this8.widgetId + '"></canvas>';
                case 'text-line':
                    valueId = _this8.itemId.replace("item-", "value_");
                    unitId = _this8.itemId.replace("item-", "unit_");
                    return ' <h2 class="text-left"><span id="' + valueId + '">0</span> <span  id="' + unitId + '">' + _this8.unit + '</span></h2>\n                             <canvas id="' + _this8.widgetId + '"></canvas>\n                            ';
                case 'Gauges':
                    valueId = _this8.itemId.replace("item-", "gauges-text-");
                    unitId = _this8.itemId.replace("item-", "unit_");
                    // <canvas id="${this.widgetId}"></canvas>
                    //<h2><span id="${valueId}">0</span> <span  id="${unitId}">${this.unit}</span></h2>
                    return '\n                            \n                            <div id="' + _this8.widgetId + '"></div>\n                            ';
                case 'Map':
                    return '\n                            <div id="' + _this8.widgetId + '"></div>\n                            ';
                case 'TextValue':
                    return '\n                            <h1 style="color:' + _this8.rgb + '"><span id="' + _this8.widgetId + '">0</span> <span>' + _this8.unit + '</span><h1>\n                            ';
                case 'TextBox':
                    return '<span id="' + _this8.widgetId + '"></span>';
                default:
                    break;
            }
        };
        ...
        this.selectWiContentFull = function () {
            ...
            switch (_this8.type) {
                case 'MutiLine':
                    return '<canvas id="' + _this8.fullScreenId + '"></canvas>';
                case 'text-line':
                    valueId = _this8.itemId.replace("item-", "value_full");
                    return ' <h2 class="text-left"><span id="' + valueId + '">0</span> ' + _this8.unit + '</h2>\n                             <canvas id="' + _this8.fullScreenId + '"></canvas>\n                            ';
                case 'Gauges':
                    valueId = _this8.itemId.replace("item-", "gauges-text-full");
                    return '\n                            <h2><span id="' + valueId + '">0</span> <span>' + _this8.unit + '</span></h2>\n                            <canvas id="' + _this8.fullScreenId + '"></canvas>\n                            ';
                case 'Map':
                    return '\n                            <div id="' + _this8.fullScreenId + '"></div>\n                            ';
                default:
                    break;
            }
        };
        ...
        this.createWidget = function () {
            ...
            var layout_widget = "";
            if (_this8.type !== "TextBox") {
                layout_widget = $("#layout-widget").html();
                if (_this8.type === "TextValue") {
                    node.width = 4;
                    node.height = 4;
                    layout_widget = $("#layout-widget-text-value").html();
                }
                layout_widget = layout_widget.replace(/div_id/g, _this8.itemId);
                layout_widget = layout_widget.replace(/widget_id/g, _this8.widgetId);
                layout_widget = layout_widget.replace("((wi))", _this8.selectWiContent());
                layout_widget = layout_widget.replace("((title_name))", _this8.title_name);
                layout_widget = layout_widget.replace("{last_update}", _this8.lastUpdateId);
            } else {
                node.width = 6;
                node.height = 1;
            ...
            g.data('_gridstack_data', JSON.stringify(formateDataSave(_this8)));
...
var MutiLine = function (_Widget) {
    ...
    function MutiLine(widget) {
        ...
        var _this9 = _possibleConstructorReturn(this, (MutiLine.__proto__ || Object.getPrototypeOf(MutiLine)).call(this, widget));

        _this9.fullScreenId = widget.fullScreenId;
        _this9.chart = null;
        _this9.datasets = widget.datasets;
        ...
        _this9.createMutiLine = function () {
            var ctx = document.getElementById(_this9.widgetId);
            //console.log(this.datasets);
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    datasets: Object(__WEBPACK_IMPORTED_MODULE_0__utility_js__["b" /* deepCopy */])(_this9.datasets)
                },
                options: options
            });
            _this9.chart = myChart;
        };

        _this9.createFullWidget = function () {
            var ctx = document.getElementById(_this9.fullScreenId);
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    datasets: Object(__WEBPACK_IMPORTED_MODULE_0__utility_js__["b" /* deepCopy */])(_this9.datasets)
        ...
        _this9.updateData = function () {
            var myChart = _this9.chart;
            ...
            myChart.data.datasets.forEach(function (dataset) {
                ...
                dataset.data.push(Datasource.getDatasourceValue(_this9.datasource));
            });

            if (myChart.data.labels.length > 10) myChart.data.labels.splice(0, 1);

            myChart.update();
            _this9.updateLastUpdate();
        };
        return _this9;
    }
...
var ChartTextLine = function (_MutiLine) {
    ...
    function ChartTextLine(widget) {
        ...
        var _this10 = _possibleConstructorReturn(this, (ChartTextLine.__proto__ || Object.getPrototypeOf(ChartTextLine)).call(this, widget));

        _this10.fullScreenId = widget.fullScreenId;
        _this10.unit = widget.unit;
        _this10.rgb = widget.rgb;
        ...
        _this10.createTextLine = function () {
            var ctx = document.getElementById(_this10.widgetId);
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: [],
                    datasets: [{
                        ...
                        borderColor: [_this10.rgb],
                        borderWidth: 2
                    }]
                },
                options: optionChartLineNotLable
            });
            _this10.chart = myChart;
            _this10.updateData();
            return myChart;
        };

        _this10.createFullWidget = function () {
            var ctx = document.getElementById(_this10.fullScreenId);
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: [],
        ...
        _this10.updateData = function () {
            ...
            var value = _this10.widgetId;
            value = value.replace("myChart_", "value_");
            var myChart = _this10.chart;
            ...
            myChart.update();
            _this10.updateLastUpdate();
        };

        _this10.liveData = function () {
            var value = _this10.widgetId;
            value = value.replace("myChart_", "value_");
            var myChart = _this10.chart;
            var d = new Date();
...
var Gauges = function (_Widget2) {
    ...
    function Gauges(widget) {
        ...
        var _this11 = _possibleConstructorReturn(this, (Gauges.__proto__ || Object.getPrototypeOf(Gauges)).call(this, widget));

        _this11.fullScreenId = widget.fullScreenId;
        _this11.textId = widget.textId;
        _this11.gaugeWidget = null;
        _this11.opts = widget.opts;
        _this11.limitMax = widget.limitMax ? widget.limitMax : 100;
        _this11.limitMin = widget.limitMin ? widget.limitMin : 0;
        _this11.unit = widget.unit;

        _this11.createGages = function () {
            _this11.gaugeWidget = new JustGage({
                id: _this11.widgetId,
                value: getRandomInt(Number(_this11.limitMin), Number(_this11.limitMax)),
                min: _this11.limitMin,
                max: _this11.limitMax,
                symbol: ' ' + _this11.unit,
                relativeGaugeSize: true,
                titlePosition: "below"
            });
            $("#" + _this11.widgetId).height($("#" + _this11.widgetId).height() - 5);
            $("#" + _this11.widgetId).addClass('container');
            _this11.updateData();
        ...
        _this11.updateData = function () {
            ...
            _this11.gaugeWidget.refresh(getRandomInt(Number(_this11.limitMin), Number(_this11.limitMax)));
...
var Map = function (_Widget3) {
    ...
    function Map(widget) {
        ...
        var _this12 = _possibleConstructorReturn(this, (Map.__proto__ || Object.getPrototypeOf(Map)).call(this, widget));

        _this12.fullScreenId = widget.fullScreenId;
        _this12.myMap = null;

        _this12.createMap = function () {
            var mymap = void 0;
            var mapid = _this12.widgetId;
            var height = $("#" + _this12.itemId).height() - 100;
            ...
            _this12.myMap = mymap;
            console.log(_this12.myMap);
        };

        _this12.createFullWidget = function () {
            var mymap = void 0;
            var mapid = _this12.fullScreenId;
            var height = "450px";
            $('#' + mapid).css('height', height);
            $('#' + mapid).css('width', 'auto');
...
var TextValue = function (_Widget4) {
    _inherits(TextValue, _Widget4);

    function TextValue(widget) {
        _classCallCheck(this, TextValue);

        var _this13 = _possibleConstructorReturn(this, (TextValue.__proto__ || Object.getPrototypeOf(TextValue)).call(this, widget));

        _this13.textValue = widget.textValue;
        _this13.unit = widget.unit;
        _this13.rgb = widget.rgb;

        _this13.createTextValue = function () {
            _this13.updateData();
        };

        _this13.updateData = function () {
            var data = Math.floor(Math.random() * (100 - 1));
            $("#" + _this13.widgetId).html(data);
...
var TextBox = function (_Widget5) {
    _inherits(TextBox, _Widget5);

    function TextBox(widget) {
        _classCallCheck(this, TextBox);

        var _this14 = _possibleConstructorReturn(this, (TextBox.__proto__ || Object.getPrototypeOf(TextBox)).call(this, widget));

        _this14.textbox = widget.textbox;
        _this14.fontsize = widget.fontsize;
        _this14.createTextBox = function () {
            console.log($("#" + _this14.widgetId));
            $("#" + _this14.widgetId).html(_this14.textbox);
            $("#" + _this14.widgetId).css({ "font-size": _this14.fontsize + "px" });
        };
        return _this14;
    }
...
var Datasources = function Datasources() {
    ...
    var getWebServices = function getWebServices() {
        $.ajax({
    ...
    var updateListDatasource = function updateListDatasource() {
        ...
        var html = "<h5>Datasource</h5>";
        var opt = "<option value=''>--Select datasource--</option>";
        listDatasource.map(function (data, index) {
            html += '<div class="row">\n                            <div class="col-2">\n                                ' + data.name + '\n                            </div>\n                            <div class="col-2" id="datasource-isActive-' + index + '">\n                                Not active\n                            </div>\n                            <div class="col-3" id="datasource-' + index + '">\n\n                            </div>\n                        </div>';
    ...
    var getApiDatasource = function getApiDatasource(index) {
        //url: '/js/company/test-api.json',
        var url = listDatasource[index].URL;
        var name = listDatasource[index].name;
        $.ajax({
            url: '/js/company/test-api.json',
            success: function success(res) {
                var lastUpdate = new Date();
                $("#datasource-" + index).html(lastUpdate.toDateString() + " " + lastUpdate.toLocaleTimeString());
                $("#datasource-isActive-" + index).html('Active');
    ...
    var updateDataList = function updateDataList(value) {
        ...
        if (_typeof(eval(value)) == 'object') {
            var key = Object.keys(eval(value));
            $("#data-list").empty();
    ...
    this.getDatasourceValue = function (value) {
    ...
    var bindElement = function bindElement() {
        ...
        $(".value-datasource").keyup(function () {
...
var Dashboard = function () {
    function Dashboard() {
        ...
        var getValueMutiLine = function getValueMutiLine(divId) {
            ...
            var el_datasource = $("#Mutiline_value").find('.value-datasource');
            // let value_datasource = el_datasource.map(el => {
            //     console.log($(el_datasource)[el].val());
            // });
        ...
        var getTextValue = function getTextValue(divId) {
            var unit = $("#TextValue").find("#unit").val();
            var rgb = $("#TextValue").find("#rgb").val();
            var data_widget = {
                itemId: "item-" + divId,
                widgetId: "text-value" + divId,
                lastUpdateId: "textValueLastUpdate-" + divId,
        ...
        var createDashboardInit = function createDashboardInit(dashboard) {
            ...
            for (var key in dashboard) {
                ...
                if (type === "MutiLine") {
                    ...
                    widgets.widgetId = "text-value" + divId;
                    widgets.lastUpdateId = "textValueLastUpdate" + divId;
