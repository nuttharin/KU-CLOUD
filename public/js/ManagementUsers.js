...
var ModalEdit = function ModalEdit(config) {
    ...
    this.create = function (key) {
        ...
        $('#editUser').modal('show');
        Object(__WEBPACK_IMPORTED_MODULE_1__utility__["h" /* resetInputValidate */])();
...
var ManagementUsers = function () {
    function ManagementUsers(config) {
        ...
        var createTableUsersCompany = function createTableUsersCompany() {
            if (UsersDATATABLE != null) {
                var page = UsersDATATABLE.page.info().page;
        ...
        this.showLastestDatatable = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
