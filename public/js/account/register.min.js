...
var Register = function Register() {
    ...
    var createAccount = function createAccount() {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_0__utility__["d" /* checkError */])(validateInput.address) && document.querySelector('#checkbox_address').checked) {
            return;
        } else {
    ...
    var createSelectProvices = function createSelectProvices() {
    ...
    var createSelectAmphures = function createSelectAmphures() {
    ...
    var getAmphuresByProvince = function getAmphuresByProvince($province_id) {
        $.ajax({
    ...
    var createSelectdistrict = function createSelectdistrict() {
    ...
    var getDistrictsByAmphures = function getDistrictsByAmphures(province_id, amphure_id) {
        $.ajax({
    ...
    var bindElement = function bindElement() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__utility__["b" /* addEventValidate */])(validateInput.address);
