...
var ManageCompany = function ManageCompany() {
    _classCallCheck(this, ManageCompany);
    ...
    var approveCompany = function approveCompany(index) {
        $.ajax({
    ...
    var showLastDataTable = function showLastDataTable() {
