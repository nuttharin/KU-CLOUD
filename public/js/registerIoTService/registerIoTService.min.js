...
var API = {
    getAllRegisterWebservice: "register/iotServices",
    getAllEmailCustomer: "register/iotServices/{iotservice_id}/emails",
    getIoTservices: "iot/iotservicedata",
    registerUser: "register/iotServices",
    deleteRegister: "register/iotServices"
};
...
var RegisterWebservice = function RegisterWebservice() {
    var _this = this;

    _classCallCheck(this, RegisterWebservice);

    var dataList = null;
    var iotserviceList = null;
    var dataTable = null;
    ...
    var updateDatatableData = function updateDatatableData() {
        ...
        if (Datatable.length > 0) dataTable.fnAddData(Datatable);
    ...
    var onBtnDeleteClick = function onBtnDeleteClick(index) {
        swal({
            title: "Are you sure?",
    ...
    var onBtnDeleteSubmit = function onBtnDeleteSubmit(index) {
        __WEBPACK_IMPORTED_MODULE_0__utility__["a" /* LOADING */].set($("#btn_save_register_user"));
        $.ajax({
            url: END_POINT + API.deleteRegister,
            method: "DELETE",
            data: {
                register_iot_service: dataList[index].register_iot_service,
    ...
    var registerUser = function registerUser() {
        ...
        $.ajax({
            ...
            method: "POST",
            data: {
                iotservice_id: $("#iot_name").val(),
                users: input_bind_email.val()
            },
            success: function success(res, textStatus, xhr) {
                Object(__WEBPACK_IMPORTED_MODULE_0__utility__["c" /* checkAuthRes */])(xhr);
                __WEBPACK_IMPORTED_MODULE_0__utility__["a" /* LOADING */].reset($("#btn_save_register_user"));
    ...
    var getAllEmailCustomer = function getAllEmailCustomer() {
        ...
        $.ajax({
            url: END_POINT + API.getAllEmailCustomer.replace('{iotservice_id}', $("#iot_name").val()),
            method: "GET",
            headers: {
    ...
    var createSelectWebservice = function createSelectWebservice() {
        var select = $("#iot_name");
        var opt = '<option value="">--Select IoT name--</option>';
        iotserviceList.map(function (_data) {
            opt += "<option value=\"" + _data.id + "\">" + _data.name + "</option>";
        });
    ...
    var getWebservices = function getWebservices() {
        $.ajax({
            url: END_POINT + API.getIoTservices,
            method: "GET",
            headers: {
                authorization: 'bearer ' + getCookie('token')
            },
    ...
    var resetInputEmail = function resetInputEmail() {
        input_bind_email = $('#input_bind_email');
        input_bind_email.hide();
        input_bind_email.empty();
        if (input_bind_email.data('fastselect')) {
    ...
    var bindElement = function bindElement() {
        ...
        $("#iot_name").unbind().change(function () {
            if ($(this).val() == "") {
                resetInputEmail();
                return;
            }
...
$(document).ready(function () {
    var registerWebservice = new RegisterWebservice();
