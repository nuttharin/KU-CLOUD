...
const API = {
    getAllRegisterWebservice  : "iot/iotservicedata",
    getAllEmailCustomer : "users/email/company",
    getWebservices : "register/iotServices",
    ...
    constructor(){
        ...
        let updateDatatableData = () => {
            ...
            $.each(dataList, function (index, item) {
                ...
                ret[1] = item.iot_service.service_name;
                ret[2] = `<center>
        ...
        let getAllEmailCustomer = () => {
            $.ajax({
                url: END_POINT + API.getAllEmailCustomer,
                method: "GET",
                headers: {
        ...
        let createSelectWebservice = () => {
            ...
            let opt = '<option>--Select webservice--</option>';
