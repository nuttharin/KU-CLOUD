import { LOADING,checkAuthRes,checkError,resetInputValidate,addEventValidate } from '../utility';
    ...
    constructor(){
        ...
        let updateDatatableData = () => {
            ...
            $.each(dataList, function (index, item) {
                ...
                ret[1] = item.iot_service.iot_name;
                ret[2] = `<center>
        ...
        let getAllEmailCustomer = () => {
            ...
            $.ajax({
                url: END_POINT + API.getAllEmailCustomer.replace('{iotservice_id}',$("#iot_name")),
                method: "GET",
                headers: {
        ...
        let createSelectWebservice = () => {
            let select = $("#iot_name");
            let opt = '<option value="">--Select IoT name--</option>';
            iotserviceList.map(_data => {
