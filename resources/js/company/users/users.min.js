    ...
    constructor() {
        ...
        let updateDatatableData = (userList) => {
            ...
            $.each(userList.users, function (index, item) {
                ...
                ret[5] = item.online ? '<span class="text-success">online <i class="fas fa-circle text-success fa-xs"></i></span>' : '<span class="text-secondary">offline <i class="fas fa-circle text-secondary fa-xs"></i></span>';
                ret[6] = `<center>
