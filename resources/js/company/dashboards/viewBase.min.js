    ...
    DOMString: {
        class: {
            inputIsGroupDataMutiLine: '.isGroupDataMutiLine',
                ...
                valueDatasource: '.value-datasource',
                dataList: '.data-list:visible',
                dataListValue: '.data-list-value:visible',
                valueGroupData: '.value-group-data',
              
                labelChartLine: '.label-y-chart-line',
                colorChartLine: '.rgb-chart-line',
        ...
        id: {
            ...
            unit: '#unit',
            rgb: '#rgb',
            isAreaCreate: '#areaChart',
            isAreaEdit: '#areaChartEdit',
            isHeatMap : '#isHeatMap',
            map_value_min : "#map_value_min",
            map_value_max : "#map_value_max",
        }
    },
