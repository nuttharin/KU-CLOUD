    ...
    constructor(widget, gridData = null) {
        ...
        this.updateSocket = (service_id, type) => {
            ...
            apiUpdate.map(_i => {
                ...
                timeLast =  new Date(Datasource.getValueRealtime(this.datasources[_i],'newDate'));
    ...
    constructor(widget, gridData = null) {
        ...
        this.updateData = () => {
            ...
            myChart.data.datasets.forEach((dataset) => {
                ...
                timeLast = new Date(Datasource.getValueRealtime(this.datasources[0]),'newDate');
        ...
        this.updateData = () => {
            ...
            this.radar.data.datasets.forEach((dataset) => {
                ...
                this.radar.data.labels.map(k => {
                    timeLast = new Date(Datasource.getValueRealtime(this.datasources[i],'newDate'));
...
class Gauges extends Widget {
    constructor(widget, gridData = null) {
        ...
        this.updateData = () => {
            ...
            let data = Datasource.getValueRealtime(this.datasources[0]);
            this.gaugeWidget.refresh(data ? data : 0);
            let timeLast = new Date(Datasource.getValueRealtime(this.datasources[0]),'newDate');
            this.updateLastUpdate(timeLast);
            ...
            try {
                ...
                this.el.find('tbody tr').each(function () {
                    ...
                    $(this).find('td').not(':first').each(function () {
                        timeLast = new Date(Datasource.getValueRealtime(rows[i].data[j],'newDate'));
