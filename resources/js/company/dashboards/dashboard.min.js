...
const API_DW_DATA = {
    getLastDataIoT: `${API_DW}iotService/getInputIoTData`,
    getByTimeDataIoT: `${API_DW}iotService/getInputIoTData_Time`,
    getAggrDataIoT: `${API_DW}iotService/getInputAggregationForWeb`,
    getLastAggrDataIoT: `${API_DW}iotService/getInputAggregationForWebLastest`,
    getLastDataWebService: `${API_DW}webService/getLastestData`,
    getByTimeDataWebService: `${API_DW}webService/getallDataBytime`,
    getAggrDataWebService: `${API_DW}webService/getDataAggregation_Time`,
    getLastAggrDataWebService: `${API_DW}webService/getDataAggregationLastest`,
}
...
class ModalEditWidget {
    constructor(widget) {
        ...
        this.createModalEdit = (inputHtml, bindElement) => {
            ...
            state.editModalIdSelect.unbind().on('click', '.close', function () {
...
class ModalEditWidgetMutiLine extends ModalEditWidget {
    constructor(widget) {
        ...
        let datasourceInput = ` 
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input class="form-control value-datasource" value="{{value-datasource}}" autocomplete="off">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="form-in-line mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="areaChartEdit" name="areaChartEdit">
                                    <label class="custom-control-label" for="areaChartEdit">Area Charts</label>
                                  </div>
                        </div>
        ...
        let onSubmit = () => {
            // validateInput.edit.mutiline.parent = `#${widget.editModalId}`;
            // if(checkError(validateInput.edit.mutiline)) return;
        ...
        let setElement = () => {
            ...
            state.editModalIdSelect.find("#areaChartEdit").prop('checked', widget.isArea);
        };
...
class ModalEditWidgetBar extends ModalEditWidget {
    constructor(widget) {
        super(widget);
        let datasourceInput = ` 
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <label for="">Label <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control label-bar" value="{{label-bar}}">
                                    </div>
                                    <div class="col-2">
                                        <label for="">Color <span class="text-danger">*</span></label>
                                        <input type="color" id="rgb" class="form-control color-bar" value="{{color-bar}}">
                                    </div>
                                    {{delete}}
                                </div>`;
        ...
        let inputHtml = `
                        ...
                        <button class="btn btn-primary btn-sm btn-radius mt-2 mb-2 btn_edit_add_datasource_bar" >
                            <i class="fa fa-plus"></i>
                            Add datasource
                        </button>
                            {{datasources}}
        ...
        let bindElement = () => {
            ...
            state.editModalIdSelect.find(".btn_edit_add_datasource_bar").unbind().click(function () {
                let htmlData = datasourceInput;
                htmlData = htmlData.replace('{{value-datasource}}', "")
                htmlData = htmlData.replace('{{value-datasource}}', "")
                htmlData = htmlData.replace('{{label-bar}}', "");
                htmlData = htmlData.replace('{{color-bar}}', "#f6b73c");
                htmlData = htmlData.replace('{{delete}}', deleteEl);
                let d = $(this).parent().append(htmlData);
                Datasource.setEventEl(d.find(".select-datasource").last(), widget, true);
            });
        ...
        let createDatasourceInput = () => {
            ...
            this.widget.datasources.map(_data => {
                ...
                htmlData = htmlData.replace('{{value-datasource}}', _data.val)
                htmlData = htmlData.replace('{{value-datasource}}', _data.val)
                htmlData = htmlData.replace('{{label-bar}}', this.widget.datasets[i].label);
                htmlData = htmlData.replace('{{color-bar}}', this.widget.datasets[i].borderColor);
                htmlData = htmlData.replace('{{delete}}', deleteEl);
                html += htmlData;
                i++;
            })
...
class ModalEditWidgetMap extends ModalEditWidget {
    constructor(widget) {
        ...
        let inputHtml = `<div class="row" id="div-title">
                        ...
                        <div class="form-in-line mt-2 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="isHeatMapEdit" name="isHeatMapEdit">
                                    <label class="custom-control-label" for="isHeatMapEdit">Heat map</label>
                                </div>
                            </div>
        ...
        let datasourceInput = `  
                            <div class="row value-of-map">
                                <div class="col-3">
                                    ...
                                    <input class="form-control value-datasource latitude" value="{{latitude}}" autocomplete="off">
                                    <ul class="list-group data-list">
                                </div>
                                <div class="col-3">
                                    <label for="">Longitude <span class="text-danger">*</span></label>
                                    <input class="form-control value-datasource longitude" value="{{longitude}}" autocomplete="off">
                                    <ul class="list-group data-list">
                                </div>
                                <div class="col-3">
                                    <label for="">Value <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control value-datasource value-map" value="{{value-map}}" autocomplete="off">
                                    <ul class="list-group data-list">
                                </div>
                                <div class="col-2">
                                    <label for="">Label <span class="text-danger">*</span></label>
        ...
        let bindElement = () => {
            ...
            state.editModalIdSelect.find("#isHeatMapEdit").unbind().click(function () {
                if ($(this).prop('checked')) {
                    state.editModalIdSelect.find("#max_min_value").show();
                } else {
                    state.editModalIdSelect.find("#max_min_value").hide();
                }
            });
        ...
        let setElement = () => {
            ...
            state.editModalIdSelect.find("#isHeatMapEdit").prop("checked", widget.isHeatMap)
            if (widget.isHeatMap) {
                state.editModalIdSelect.find("#max_min_value").show();
                state.editModalIdSelect.find("#map_value_min").val(widget.min);
                state.editModalIdSelect.find("#map_value_max").val(widget.max);
            }
        };
...
class ModalEditTextLine extends ModalEditWidget {
    constructor(widget) {
        ...
        let onSubmit = () => {
            let title = state.editModalIdSelect.find("#edit_title").val();
            let unit = state.editModalIdSelect.find("#edit_unit").val();
            let unitId = this.widget.itemId.replace("item-", "unit-");
            $(this.findTitleWidget()).html(title);
            $("#" + unitId).html(unit);
            this.widget.title_name = title;
            this.widget.unit = unit;
    ...
    constructor(widget) {
        ...
        let bindElement = () => {
            ...
            state.editModalIdSelect.find("#btn_add_col").unbind().click(function () {
                tableEx.addCol();
                Datasource.addEventTable(state.editModalIdSelect.find(".select-datasource"), true, false);
            });
            ...
            state.editModalIdSelect.find("#btn_add_row").unbind().click(function () {
                tableEx.addRow();
                Datasource.addEventTable(state.editModalIdSelect.find(".select-datasource"), false, false);
            });
...
class Widget {
    constructor(widget, gridData = null) {
        ...
        let onEditWidgetClick = (el) => {
            ...
            } else if (widget.type === WIDGET_TYPE.BAR_STATIC) {
                modal = new ModalEditWidgetBar(widget);
        ...
        let bindWidgetElement = () => {
            ...
            if (this.type.search('static') !== -1) {
                // $(".type_report").unbind().change(function () {
                //     let widget = Dashboard.getWidgetById($(this).attr('item'));
                //     $("#" + $(this).attr('item')).find("input[type='date']").val('');
                //     $("#" + $(this).attr('item')).find("input[type='month']").val('');
                //     $("#" + $(this).attr('item')).find("input[type='number']").val('');
                ...
                $(".type-report").unbind().click(function () {
                    let item = $(this).attr('item');
                    let footer = $("#" + item).find('.card-footer');
                    if ($(this).hasClass('active')) {

                    } else {
                        footer.find(".btn.type-report").removeClass('active');
                        $(this).addClass('active')
                    }

                    let widget = Dashboard.getWidgetById(item);
                    $("#" + item).find("input[type='date']").val('');
                    $("#" + item).find("input[type='month']").val('');
                    $("#" + item).find("input[type='number']").val('');

                    let val = $(this).attr('valueType');
                    widget.periodType = val;
                    footer.find(".daily").hide();
                    footer.find(".monthly").hide();
                    footer.find(".yearly").hide();
                    if (val === "daily") {
                ...
                $(".start_day").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.startDate = moment(new Date($(this).val())).startOf('day');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
                    }
                    //console.log(widget.startDate)
                });

                $(".end_day").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.endDate = moment(new Date($(this).val())).endOf('day');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
                    }
                    //console.log(widget.endDate)
                });


                $(".start_month").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.startDate = moment(new Date($(this).val())).startOf('month').format('YYYY-MM-DD HH:mm:ss');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
                    }
                    // console.log(widget.startDate)
                ...
                $(".end_month").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.endDate = moment(new Date($(this).val())).endOf('month').format('YYYY-MM-DD HH:mm:ss');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
                    }
                    //console.log(widget.endDate)
                ...
                $(".start_year").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.startDate = moment(new Date($(this).val())).startOf('month').format('YYYY-MM-DD HH:mm:ss');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
                ...
                $(".end_year").unbind().change(function () {
                    let widget = Dashboard.getWidgetById($(this).attr('item'));
                    widget.endDate = moment(new Date($(this).val())).endOf('month').format('YYYY-MM-DD HH:mm:ss');
                    if (moment(widget.endDate).diff(moment(widget.startDate), 'days') >= 0) {
                        widget.updateStatic();
        ...
        this.createWidget = (gridData = null) => {
            ...
            if (this.type !== WIDGET_TYPE.MUTILINE) {
                ...
                if (this.type === WIDGET_TYPE.GAUGES) {
                    g.find('.btn-download-excel').remove();
                } else if (this.type == WIDGET_TYPE.TEXTLINE || this.type == WIDGET_TYPE.MAP) {
                    g.find('.download').remove();
                }
            } else {
    ...
    static formateDataSave(data) {
        ...
        if (data.type === WIDGET_TYPE.MUTILINE || data.type === WIDGET_TYPE.MUTILINE_STATIC) {
            ...
            formateDate.isArea = data.isArea;
        ...
        } else if (data.type === WIDGET_TYPE.BAR_STATIC) {
            formateDate.title_name = data.title_name;
            formateDate.datasets = data.datasets;
            formateDate.axis_x = data.axis_x;
            formateDate.axis_y = data.axis_y;
            ...
            formateDate.isHeatMap = data.isHeatMap ? data.isHeatMap : false;
            formateDate.max = data.max ? data.max : null;
            formateDate.min = data.min ? data.min : null;
            formateDate.isGroupData = data.isGroupData;
            formateDate.title_name = data.title_name;
...
class MutiLineStatic extends Widget {
    constructor(widget, gridData = null) {
        ...
        let yesterday = moment(new Date()).subtract(1, 'days').toISOString();
        this.periodType = "daily";
        this.startDate = moment(yesterday).startOf('day').toISOString();
        this.endDate = moment(yesterday).endOf('day').toISOString();
        ...
        this.updateStatic = async () => {
            ...
            for (let i = 0; i < datasources.length; i++) {
                let data = await Datasource.getValueStaticByTime(datasources[i], this.startDate, this.endDate, this.periodType);
                this.static[datasources[i].type][datasources[i].id] = data;
            }
            ...
            myChart.data.datasets.forEach((dataset) => {
                let datasource = this.static[this.datasources[i].type][this.datasources[i].id];

                if (this.datasources[i].type === "web_services") {
                    datasource.map(_d => {
                        dataset.data.push({
                            x: new Date(objectPath.get(_d, 'real_date')),
                            y: objectPath.get(_d.data, this.datasources[i].val)
                        })
                    })
                } else {
                    datasource.map(_d => {
        ...
        this.updatePropWidget = () => {
            ...
            let isArea = state.editModalIdSelect.find(elements.DOMString.id.isAreaEdit);
            ...
            for (let i = 0; i < length_label; i++) {
                ...
                data = {
                    label: $(label_y[i]).val(),
                    backgroundColor: this.isArea ? convertHex($(rgb[i]).val(), 30) : rgba,
        ...
        this.exportToExcel = () => {
            let data = [];
            let dataExcel = [];
            this.chart.data.datasets.map(_data => {
                let {
                    label,
                    data
                } = _data;
                data.map(_dataChart => {
                    ...
                    dataValue[this.chart.config.options.scales.xAxes[0].scaleLabel.labelString] = _dataChart.x;
                    dataValue[this.chart.config.options.scales.yAxes[0].scaleLabel.labelString] = _dataChart.y;
    ...
    constructor(widget, gridData = null) {
        ...
        let options = {
            ...
            tooltips: {
                ...
                //         return data['datasets'][0].label + " : " + data['datasets'][0]['data'][tooltipItem['index']].y;
                //     },
        ...
        this.createMutiLine = () => {
            ...
            if (!this.isAllow) return;
            if (validate.isEmpty(this.isArea)) {
                this.isArea = false;
            }
        ...
        let getDataTimeSeries = async (datasource) => {
            ...
            if (list) {
                if (datasource.type == "iot_services") {
                    url = API_DW_DATA.getByTimeDataIoT
                    param = {
                    ...
                    url = API_DW_DATA.getByTimeDataWebService
                    param = {
                        nameDW: list.service_name_DW,
                        start_date: this.startDate,
                        end_date: this.endDate,
                    };
                }
        ...
        this.exportToExcel = () => {
            ...
            chart.data.datasets.map(_data => {
                ...
                data.map(_dataChart => {
                    let dataValue = {};
                    dataValue['label'] = label;
                    dataValue[chart.config.options.scales.xAxes[0].scaleLabel.labelString ? chart.config.options.scales.xAxes[0].scaleLabel.labelString : 'Time'] = _dataChart.x;
...
class BarStatic extends Widget {
    constructor(widget, gridData = null) {
        super(widget, gridData);
        this.chart = null;
        this.datasets = widget.datasets;
        ...
        this.periodType = "daily";
        this.startDate = moment(yesterday).startOf('day').format('YYYY-MM-DD HH:mm:ss');
        this.endDate = moment(yesterday).endOf('day').format('YYYY-MM-DD HH:mm:ss');
        ...
        this.updatePropWidget = () => {
            ...
            let data_widget = null;
            let el = $("#" + this.editModalId);
            let length_label = el.find(elements.DOMString.class.labelBar).length;
            let value_datasource = [];
            ...
            for (let i = 0; i < length_label; i++) {
                let label_y = el.find(elements.DOMString.class.labelBar);
                let rgb = el.find(elements.DOMString.class.colorBar);
                let rgba = 'rgba(255,255,255,0.0)';
                let data = null;
                data = {
                    label: $(label_y[i]).val(),
                    backgroundColor: convertHex($(rgb[i]).val(), 30),
                    borderColor: $(rgb[i]).val(),
                    lineTension: 0,
                    pointRadius: 0,
                    borderWidth: 2
        ...
        this.exportToExcel = () => {
            ...
            this.chart.data.datasets.map(_data => {
                ...
                data.map(_dataChart => {
                    let dataValue = {};
                    dataValue['label'] = label;
                    dataValue[this.chart.config.options.scales.xAxes[0].scaleLabel.labelString ? this.chart.config.options.scales.xAxes[0].scaleLabel.labelString : "Time"] = _dataChart.x;
                    dataValue[this.chart.config.options.scales.yAxes[0].scaleLabel.labelString] = _dataChart.y;
                    dataExcel.push(dataValue);
                });
...
class ChartTextLine extends Widget {
    constructor(widget, gridData = null) {
        ...
        this.createTextLine = () => {
            if (!this.isAllow) return;
            let ctx = document.getElementById(this.widgetId).getContext("2d");
            // var gradientStrokeBlue = ctx.createLinearGradient(1, 2, 1, 280);
            // gradientStrokeBlue.addColorStop(0, convertHex(this.rgb,37));
            // gradientStrokeBlue.addColorStop(1, convertHex(this.rgb,40));
            ...
            let myChart = new Chart(ctx, {
                ...
                data: {
                    labels: [],
                    datasets: [{
                        backgroundColor: convertHex(this.rgb, 20),
                        data: [],
                        borderColor: [
                            this.rgb
                        ],
        ...
        this.updatePropWidget = () => {
            ...
            let myChart = this.chart;
            myChart.data.datasets[0].backgroundColor = convertHex(rgb, 20),
...
class Map extends Widget {
    constructor(widget, gridData = null) {
        ...
        this.fullScreenId = widget.fullScreenId;
        this.myMap = null;
        this.isHeatMap = widget.isHeatMap;
        this.min = widget.min;
        this.max = widget.max;
            ...
            try {
                ...
                if (!this.isGroupData) {
                    ...
                    this.datasources.map(data => {
                        ...
                        if (this.isHeatMap) {
                            let heat = [];
                            let data = (value - Number(this.min)) / Number(this.max)
                            heat.push([lat, lon, data]);
                            L.heatLayer(heat, {
                                radius: 50,
                            }).addTo(this.markers);
                        }
                    ...
                    for (let i in datasource) {
                        let lat = Number(objectPath.get(Datasource.getDatasources(), this.datasources.latitude.replace('[]', i)));
                        let lon = Number(objectPath.get(Datasource.getDatasources(), this.datasources.longitude.replace('[]', i)));
        ...
        this.updatePropWidget = () => {
            ...
            this.isHeatMap = state.editModalIdSelect.find('#isHeatMapEdit').prop('checked');
            this.max = state.editModalIdSelect.find("#map_value_max").val();
            this.min = state.editModalIdSelect.find("#map_value_min").val();
...
class TableStatic extends Widget {
    constructor(widget, gridData = null) {
        ...
        this.createTable = async () => {
            if (!this.isAllow) return;
            this.static = await Datasource.getValueStaticByTime(this.datasources[0], this.startDate, this.endDate, this.periodType);
            this.el = $('#' + this.widgetId);
            this.el.find('thead').append('<tr></tr>');
            for (let i = 0; i < this.table.col_labels.length; i++) {
                this.el.find('thead tr').append(`<th>${this.table.col_labels[i]}</th>`);
            ...
            for (let k = 0; k < this.static.length; k++) {
                console.log(this.static.length);
                let rows = '';
                let date = null;
                let dateStr = "";
                for (let i = 0; i < this.table.rows.length; i++) {
                    ...
                    for (let j = 0; j < this.table.col_labels.length; j++) {
                        if (j === 0) {
                            ...
                            let data = objectPath.get(this.datasources[0].type == "iot_services" ? this.static[k] : this.static[k].data, this.table.rows[i].data[j - 1].val); // value
                            date = objectPath.get(this.static[k], 'real_date'); //date

                            switch (this.periodType) {
                                case 'daily':
                                    dateStr = moment(new Date(date)).format('YYYY-MM-DD');
                                    break;
                                case 'monthly':
                                    dateStr = moment(new Date(date)).format('YYYY-MM');
                                    break;
                                case 'yearly':
                                    dateStr = moment(new Date(date)).format('YYYY');
                                    break;
                                default:
                                    break;
                            }
                ...
                <tr class="text-left bg-light">
                    <td colspan="${this.table.col_labels.length}"><b>${dateStr}</b> 
            ...
            $('#' + this.widgetId).parent().parent().css({
                "overflow-y": "auto",
            });
            // $('#' + this.widgetId).css({
            //     "width": "100%",
        ...
        this.exportToExcel = () => {
            ...
            for (let k = 0; k < this.static.length; k++) {
                ...
                for (let i = 0; i < this.table.rows.length; i++) {
                    ...
                    for (let j = 0; j < this.table.col_labels.length; j++) {
                        if (j === 0) {
                            dataExcel[this.table.col_labels[j]] = this.table.rows[i].label;
                        } else {
                            let data = objectPath.get(this.static[k], this.table.rows[i].data[j - 1].val); // value
                            date = objectPath.get(this.static[k], 'real_date'); //date
                            dataExcel[this.table.col_labels[j]] = data
                            switch (this.periodType) {
                                case 'daily':
                                    dateStr = moment(new Date(date)).format('YYYY-MM-DD');
                                    break;
...
class Datasources {
    constructor() {
        ...
        let getRawData = async (datasource, label) => {
            ...
            if (label === "web_services") {
                let param = {
                    nameDW: datasource.service_name_DW,
                };
                data = await axios.post(API_DW_DATA.getLastDataWebService,
                    param, {
                        headers: {
                            'Content-Type': 'application/json',
                            "Authorization": getCookie('token'),
                ...
                ex.web_services.realtime[datasource.webservice_id] = data.data[0];

            } else if (label === "iot_services") {
                data = await axios.post(API_DW_DATA.getLastDataIoT, {
        ...
        let getStaticData = async (datasource, label) => {
            //url: '/js/company/test-api2.json',
            try {
                let data = null; //await axios.get('/js/company/test-aggr.json');
                if (label === "web_services") {
                    data = await axios.post(API_DW_DATA.getLastAggrDataWebService, {
                        nameDW: datasource.service_name_DW,
                        type: "Day",
                    }, {
                        headers: {
                    ...
                    data = await axios.post(API_DW_DATA.getLastAggrDataIoT, {
                        nameDW: datasource.iot_name_DW,
                        type: "Day",
                    }, {
                        headers: {
                            'Content-Type': 'application/json',
                    ...
                    ex.iot_services.static[datasource.iotservice_id] = data.data[0];
                }
            } catch (e) {
        ...
        this.addEventTable = async (el, isAddCol, isRealTime = true) => {
        ...
        this.setEventEl = async (el, widget, isAdd = false) => {
            el.unbind().change(async function () {
                ...
                if (widget.type !== WIDGET_TYPE.TABLE && widget.type !== WIDGET_TYPE.TABLE_STATIC) {
                    let value = null;
                    ...
                    let value = state.editModalIdSelect.find(".value-datasource");
                    if ($(this).val() != '') {
                        let label = getLabelSelectGroup(this);
                        let datasource = findDatasource($(this).val(), label);
                        if (widget.type.search("static") < 0) {
                        ...
                        state.apiName = datasource.name;
                        //$(this).parent().parent().next().find(".value-datasource").focus();
                        createDataList2(value, datasource, label, state.isRealTime);
                        //createDataList(datasource.name, value.find(".value-datasource"));
                    } else {
                        state.editModalIdSelect.find(".data-list").empty();
                        value.val('')
                    }
        ...
        let bindElement = async () => {
            ...
            $("#Mutiline_value,#bar_value").on('change', '.select-datasource', async function () {
                let value = $(this).parent().parent();
                value.find(".value-datasource").val('');
                value.find(".data-list").hide();
                if ($(this).val() != '') {
            ...
            $('#Mutiline_value,#bar_value,#Gauges,#TextValue,#text-line,#Radar,#Table,#map_value').on('keyup', '.value-datasource', function () {
            ...
            $("#btn_add_datasource_bar").unbind().click(function () {
                let formhtml = $("#bar_value_layout").first().html();
                let html = elements.barValue.append(formhtml);
            });
        ...
        this.getValueStaticByTime = async (datasource, startDate, endDate, periodType) => {
            let url = "";
            let param = "";

            //console.log(this.startDate, this.endDate);
            let list = this.findListDatasource(datasource.id, datasource.type);

            if (list) {
                if (datasource.type == "iot_services") {
                    url = API_DW_DATA.getAggrDataIoT //`/js/company/test-aggr-${this.periodType}.json`; 
                    param = {
                        nameDW: list.iot_name_DW,
                        type: PERIOD_STATIC[periodType],
                        start_date: startDate,
                        end_date: endDate,
                    };
                } else if (datasource.type == "web_services") {

                    url = API_DW_DATA.getAggrDataWebService //'/js/company/test-api-static.json';
                    param = {
                        nameDW: list.service_name_DW,
                        type: PERIOD_STATIC[periodType],
                        start_date: startDate,
        ...
        this.findListDatasource = (service_id, type) => {
            if (!validate.isEmpty(service_id)) {
                let list = null;
                if (type === "web_services") {
                ...
                if (list) {
                    ...
                    if (type === "web_services") {
                        if (!hasService(service_id, type)) {
                            ...
                            realtime = await axios.post(API_DW_DATA.getLastDataWebService, {
                                nameDW: list.service_name_DW,
                            }, {
                                headers: {
                                    'Content-Type': 'application/json',
                            ...
                            datasources.web_services.realtime[service_id] = realtime.data[0]
                        }
                        //firstData = await axios.get('/js/company/test-api-static.json');
                        firstData = await axios.post(API_DW_DATA.getByTimeDataWebService, {
                            nameDW: list.service_name_DW,
                        ...
                        if (!hasService(service_id, type)) {
                            realtime = await axios.post(API_DW_DATA.getLastDataIoT, {
                                tableDW_name: list.iot_name_DW
                            }, {
                                headers: {
                                    'Content-Type': 'application/json',
                        ...
                        firstData = await axios.post(API_DW_DATA.getByTimeDataIoT, {
                            tableDW_name: list.iot_name_DW,
                            start_date: start_date,
                            end_date: end_date
                        }, {
                        ...
                        }) //.then(response => console.info("headers:", response));
        ...
        this.datasourcesHasInCompany = (datasources, itemId) => {
            let has = true;
            if (state.config.type_user === "COMPANY" && state.config.user_id != "Me") {
                if (datasources.length) {
                    for (let i = 0; i < datasources.length; i++) {
                        if (validate.isEmpty(datasources[i].id)) {
                            has = true;
                            continue;
                        }
            ...
            if (!has) {
                ...
                $("#" + itemId).find(".card-header > div >h5").append('<span class="badge badge-pill badge-danger ml-2">Unauthorized</span>')
                ...
                card_body.html(`<h4 class="text-danger"><i class="fas fa-exclamation-circle"></i> This widget have data unauthorized !</h4>`)
            }
            return has;
        };
    ...
    constructor() {
        ...
        let getValueMutiLine = async (divId) => {
            ...
            if (!isGroupDataMutiLine) {
                ...
                let isArea = elements.mutiLineValue.find(elements.DOMString.id.isAreaCreate);
                if (isArea.prop('checked')) {
                    isArea = true;
                } else {
                    isArea = false;
                ...
                for (let i = 0; i < length_label; i++) {
                    ...
                    data = {
                        label: $(label_y[i]).val(),
                        backgroundColor: isArea ? convertHex($(rgb[i]).val(), 30) : rgba,
                        borderColor: $(rgb[i]).val(),
                        lineTension: 0,
                        pointRadius: 0,
                        borderWidth: 2
        ...
        let getValueBar = async (divId) => {
            let data_line = [];
            let data_widget = null;
            let length_label = elements.bar.find(elements.DOMString.class.labelBar).length;
            let value_datasource = [];

            elements.barValue.find(elements.DOMString.class.valueDatasource).each(function () {
                value_datasource.push({
                    id: $(this).attr("service_id"),
                    company_id: $(this).attr("company_id"),
                    type: $(this).attr("label"),
            ...
            for (let i = 0; i < length_label; i++) {
                let label_y = elements.barValue.find(elements.DOMString.class.labelBar);
                let rgb = elements.barValue.find(elements.DOMString.class.colorBar);
                let rgba = 'rgba(255,255,255,0.0)';
                let data = null;
                data = {
                    label: $(label_y[i]).val(),
        ...
        let getValueMap = (divId) => {
            ...
            let data_widget = null;
            let isHeatMap = false;
            if (elements.mapValue.find(elements.DOMString.id.isHeatMap).prop('checked')) {
                isHeatMap = true;
            } else {
                isHeatMap = false;
            }
            ...
            if (!isGroupDataMap) {
                ...
                data_widget = {
                    ...
                    max: $("#map_value_max").val(),
                    min: $("#map_value_min").val(),
                    isHeatMap: isHeatMap,
                    download: false,
                    type: getWigetType(),
                    title_name: getTitleName(),
        ...
        let createFormBodyInputWidget = (type) => {
            ...
            } else if (type === WIDGET_TYPE.BAR_STATIC) {
                elements.bar.show();
        ...
        let onAddWidgetClick = async () => {
            ...
            let widget = null;
            if (type === WIDGET_TYPE.MUTILINE || type === WIDGET_TYPE.MUTILINE_STATIC) {
                //if (checkError(validateInput.create.mutiline)) return
                ...
                widget = await getValueBar();
                obj_widget = new BarStatic(widget);
            } else if (type === WIDGET_TYPE.TEXTLINE) {
                //if (checkError(validateInput.create.textline)) return
                widget = getValueTextLine();
                obj_widget = new ChartTextLine(widget);
            } else if (type === WIDGET_TYPE.RADAR) {
                //if (checkError(validateInput.create.radar)) return
                widget = getValueRader();
                obj_widget = new Radar(widget);

            } else if (type === WIDGET_TYPE.GAUGES) {
                if (checkError(validateInput.create.gauges)) return
                widget = getValueGauges();
                obj_widget = new Gauges(widget);

            } else if (type === WIDGET_TYPE.MAP) {
                //if (checkError(validateInput.create.map)) return
                widget = getValueMap();
                if(widget.isHeatMap && checkError(validateInput.create.mapIsHeat)) return
                obj_widget = new Map(widget);

            } else if (type === WIDGET_TYPE.TABLE || type === WIDGET_TYPE.TABLE_STATIC) {
                //if (checkError(validateInput.create.table)) return
                ...
                //if (checkError(validateInput.create.textValue)) return
                widget = getTextValue();
                obj_widget = new TextValue(widget);

            } else if (type === WIDGET_TYPE.TEXTBOX) {
                if (checkError(validateInput.create.textbox)) return
        ...
        let bindElement = () => {
            ...
            // addEventValidate(validateInput.create.textValue);
            addEventValidate(validateInput.create.gauges);
            ...
            $("#isHeatMap").unbind().click(function () {
                if ($(this).prop('checked')) {
                    $("#max_min_value").show();
                } else {
                    $("#max_min_value").hide();
        ...
        let createDashboardInit = async (dashboard) => {
            ...
            dashboard.map((data, key) => {
                ...
                if (type === WIDGET_TYPE.MUTILINE) {
                    ...
                    obj_widget = new BarStatic(widgets, gridData);
                } else if (type === WIDGET_TYPE.GAUGES) {
