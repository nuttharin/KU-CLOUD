...
class Datasources {
    constructor() {
        ...
        let createDataList2 = async (el, datasource, label) => {
            ...
            if (label === "web_services") {
                ...
                exData = await getFlatObjectV2(ex.web_services.realtime[datasource.webservice_id]);
            } else if (label === "iot_services") {
                el.attr("service_id", datasource.iot_service_id)
                exData = await getFlatObjectV2(ex.iot_services.realtime[datasource.iot_service_id]);
            }


            if (await forList(dataList, exData)) {
                loader.hide();
            }
