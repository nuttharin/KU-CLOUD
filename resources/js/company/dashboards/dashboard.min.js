    ...
    constructor(widget) {
        ...
        let bindElement = () => {
            ...
            state.editModalIdSelect.find("#btn_add_row").unbind().click(function () {
                ...
                state.editModalIdSelect.find(".edit_example_table").find('tbody tr').last().find('td').each(function () {
...
class Datasources {
    constructor() {
        ...
        this.setEventEl = async (el, widget, isAdd = false) => {
            ...
            $(`#${widget.editModalId} .modal-body .value-datasource`).unbind().on('focus',function () {
