    ...
    constructor(widget) {
        ...
        this.createModalEdit = (inputHtml, bindElement) => {
            ...
            if (!state.editModalIdSelect.length) {
                ...
                ModalEditWidget = `<div class="modal" id="${this.widget.editModalId}">
    ...
    constructor(widget) {
        ...
        let bindElement = () => {
            ...
            state.editModalIdSelect.find("#btn_add_row").unbind().click(function () {
                ...
                $(".edit_example_table").find('tbody tr').last().find('td').each(function () {

                    Datasource.setEventEl($(this).find(".value-datasource"), widget, true)
                })
...
class Datasources {
    constructor() {
        ...
        this.setEventEl = async (el, widget, isAdd = false) => {
            ...
            $(`#${widget.editModalId} .modal-body .value-datasource`).on('focusin', function () {
