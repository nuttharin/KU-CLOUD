        ...
        this.updateFirstData = () => {
            ...
            try {
                if (!this.isGroupData) {
                    ...
                    let datasource_daily = Datasource.getValueFirstData(this.datasources[i]);
                    console.log(Datasource.getDatasources());
...
class Datasources {
    constructor() {
        ...
        this.getValueFirstData = (datasource) => {
            if (datasource.type == "web_services") {
                return datasources.web_services.firstData[datasource.id];
            } else if (datasource.type == "iot_services") {
                returndatasources.iot_services.firstData[datasource.id];
            }
        }
...
class Dashboard {
    constructor() {
        ...
        let onAddWidgetClick = async () => {
            ...
            if (obj_widget.type != WIDGET_TYPE.TABLE) {
                obj_widget.datasources.map(_d => {
                    pushAllDatasource(_d.id, _d.type);
                })
            }
