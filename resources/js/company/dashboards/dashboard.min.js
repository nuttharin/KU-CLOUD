            ...
            $(".period").unbind().change(function () {
                ...
                switch ($(this).val()) {
                    ...
                    case PERIOD.YESTERDAY:
                        endDate = moment(today).subtract(1, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.CURRENT_WEEK:
                        endDate = moment(today).startOf('week').format('YYYY-MM-DD'), moment(today).endOf('week').format('YYYY-MM-DD');
                        break;
                    case PERIOD.WEEK_1:
                        endDate = moment(today).subtract(7, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.WEEK_2:
                        endDate = moment(today).subtract(14, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.WEEK_4:
                        endDate = moment(today).subtract(28, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.CURRENT_MONTH:
                        endDate = moment(today).startOf('month').format('YYYY-MM-DD'), moment(today).endOf('month').format('YYYY-MM-DD');
                        break;
                    case PERIOD.LAST_MONTH:
                        endDate = moment(today).subtract(1, 'months').startOf('month').format('YYYY-MM-DD'), moment(today).subtract(1, 'months').endOf('month').format('YYYY-MM-DD');
                        break;
                    case PERIOD.MONTH_3:
                        endDate = moment(today).subtract(90, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.MONTH_6:
                        endDate = moment(today).subtract(180, 'days').format('YYYY-MM-DD');
                        break;
                    case PERIOD.MONTH_12:
                        endDate = moment(today).subtract(360, 'days').format('YYYY-MM-DD');
                        break;
                    default:
                        break;
                }
                widget.startDate = new Date(endDate);;
                widget.endDate = today;
...
class MutiLine extends Widget {
    constructor(widget, gridData = null) {
        ...
        this.startDate =new Date(moment(this.endDate).subtract(24, 'hours').format('YYYY-MM-DD HH:mm:ss'))
        ...
        this.updateSocket = (service_id, type) => {
            ...
            apiUpdate.map(_i => {
                ...
                } else if (myChart.data.datasets[_i].data.length > 20) {
        ...
        this.updateData = () => {
            ...
            myChart.data.datasets.forEach((dataset) => {
                ...
                } else if (dataset.data.length > 20) {
        ...
        let getDataTimeSeries = async (datasource) => {
            ...
            let list = Datasource.findListDatasource(datasource.id, datasource.type)[0];
...
class Datasources {
    constructor() {
        ...
        this.getFirstApi = async (service_id, type) => {
            let realtime = null;
            let firstData = null
            let list = this.findListDatasource(service_id, type)[0];
