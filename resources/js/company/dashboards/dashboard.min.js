        ...
        let getDataStatic = async (datasource) => {
            ...
            if (list) {
                if (datasource.type == "iot_services") {
                    url = `${API_DW}iotService/getInputAggregationForWeb` //`/js/company/test-aggr-${this.periodType}.json`; 
                    param = {
        ...
        let getDataTimeSeries = async (datasource) => {
            ...
            if (list) {
                if (datasource.type == "iot_services") {
                    ...
                    //url = '/js/company/test-api-static.json';
                    url = `${API_DW}webService/getallDataBytime`,
                    param = {
    ...
    constructor() {
        ...
        let getRawData = async (datasource, label) => {
            ...
            if (label === "web_services") {
                ...
                data = await axios.post(`${API_DW}webService/getLastestData`,
                    param, {
                        headers: {
                            'Content-Type': 'application/json',
                            "Authorization":getCookie('token'),
                ...
                data = await axios.post(`${API_DW}iotService/getInputIoTData`, {
        ...
        let getStaticData = async (datasource, label) => {
            ...
            if (label === "web_services") {
                ...
                data = await axios.post(`${API_DW}iotService/getInputAggregationForWebLastest`, {
                ...
                if (list) {
                    ...
                    if (type === "web_services") {
                        if (!hasService(service_id, type)) {
                            ...
                            realtime = await axios.post(`${API_DW}webService/getLastestData`,{
                                nameDW: list.service_name_DW,
                            },{
                                headers: {
                                    'Content-Type': 'application/json',
                        ...
                        firstData = await axios.post(`${API_DW}webService/getallDataBytime`,{
                            nameDW: list.service_name_DW,
