        ...
        let updateDatatableData = () => {
            ...
            dataList.map((item, index) => {
                ...
                ret[3] = `<center>
                            ...
                            <a href="${END_POINT}analysis/download/${item.path_file}/csv"><button type="button" class="btn btn-success btn-sm btn-download-csv" index=${index} data-toggle="tooltip"
                                data-placement="top" title="Download CSV">
                                <i class="fas fa-table"></i>
                            </button></a>
                            <a href="${END_POINT}analysis/download/${item.path_file}/arff"><button type="button" class="btn btn-info btn-sm btn-download-arff" index=${index} data-toggle="tooltip"
