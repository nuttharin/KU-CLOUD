    ...
    constructor() {
        ...
        this.writeOutput = (output) => {
            ...
            $("#download_tree").unbind().click(function () {
                ...
                // });
                saveSvgAsPng(document.getElementById("graph").getElementsByTagName('svg')[0], "file-name.png", {
                    scale: 5
                });
            });
...
class Analysis {
    constructor() {
        ...
        let bindElement = () => {
            ...
            addEventValidate(validateInput.process)
        ...
        let analysisProcess = () => {
            let data = {};
            let dataInput = null;
            if(checkError(validateInput.process))
                return;
            if (state.tabSelect === 'cluster-tab') {
