...
class Datasources {
    constructor() {
        ...
        let bindElement = () => {
            ...
            $('#Mutiline_value,#Gauges,#TextValue').on('change', '.select-datasource', function () {
            ...
            $('#Mutiline_value,#Gauges,#TextValue').on('focus', '.value-datasource', function () {
                $('#Mutiline_value,#Gauges,#TextValue').find('.data-list.active-data').each(function () {
                    $(this).hide();
