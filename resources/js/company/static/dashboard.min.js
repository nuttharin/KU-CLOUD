import { deepCopy, LOADING } from '../../utility.js';
    ...
    constructor(widget) {
        ...
        let bindWidgetElement = () => {
            ...
            $(".btn-download").unbind().click(function () {
                ...
                let canvas = document.getElementById(widget.widgetId);
    ...
    constructor(widget) {
        ...
        this.updateData = () => {
            ...
            myChart.data.datasets.forEach((dataset) => {
                ...
                dataset.data.push(Datasource.getDatasourceValue(this.datasource));
            });
    ...
    constructor(widget) {
        ...
        this.createGages = () => {
            this.gaugeWidget = new JustGage({
                id: this.widgetId,
                value: getRandomInt(Number(this.limitMin), Number(this.limitMax)),
                min: this.limitMin,
                max: this.limitMax,
                symbol: ' ' + this.unit,
        ...
        this.updateData = () => {
            ...
            this.gaugeWidget.refresh(getRandomInt(Number(this.limitMin), Number(this.limitMax)));
            this.updateLastUpdate();
...
class Dashboard {
    constructor() {
        ...
        let getValueMutiLine = (divId) => {
            ...
            let el_datasource = $("#Mutiline_value").find('.value-datasource');
