        ...
        this.updateData = () => {
            ...
            myChart.data.datasets.forEach((dataset) => {
                ...
                if (!this.isGroupData) {
                    ...
                    // dataset.data.push({
                    //     x: date,
                    //     y: Datasource.fatoryGetDatasourceValue(this.datasource[i], this.datasource[i][1])
                    // });
                } else {
                    dataset.data.push(objectPath.get(Datasource.getDatasources(), this.datasource.replace('[]', i)));
                    // dataset.data.push({
                    //     x: date,
                    //     y: objectPath.get(Datasource.getDatasources(), this.datasource.replace('[]', i))
                    // });
                }
                i++;
            });
...
class Dashboard {
    constructor() {
        ...
        let bindElement = () => {
            ...
            $('#Mutiline_value,#map_value').on('click', '.remove-value', function () {
