import { deepCopy, convertHex } from '../../utility.js';
    ...
    constructor() {
        ...
        let updateDataList = (value, el = null) => {
            ...
            $(".back-value-data").unbind().click(function () {
                ...
                $(this).parent().parent().find('.value-datasource').val(value);
                updateDataList(value, $(this).parent().parent().find('.value-datasource'));
            });
        };
        ...
        let bindElement = () => {
            ...
            $("#Mutiline_value").on('change', '.select-datasource', function () {
                $(this).parent().parent().next().find(".value-datasource").val('');
                $(this).parent().parent().next().find(".data-list").hide();
                if ($(this).val() != '') {
                    let datasource = findDatasource($(this).val());
                    $(this).parent().parent().next().find(".value-datasource").focus();
                    createDataList(datasource.name, $(this).parent().parent().next().find(".value-datasource"));
                }
                else {
            ...
            // $('#Radar').on('blur', '.value-datasource', function () {
            //     $(this).parent().parent().find('.data-list.active-data').each(function () {
            //         $(this).hide();
            //         $(this).removeClass('active-data');
            //     });
