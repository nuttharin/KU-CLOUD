...
class Gauges extends Widget {
    constructor(widget) {
        ...
        this.updateData = () => {
            ...
            this.gaugeWidget.refresh(getRandomInt(0, 100));
            this.updateLastUpdate();
...
class Dashboard {
    constructor() {
        ...
        let saveGrid = () => {
            ...
            $.ajax({
                url: 'http://localhost:8000/api/company/static/dashboard',
                method: "PUT",
                data: {
            ...
            $.ajax({
                ...
                success: (res) => {
                    ...
                    listDatasource.map(data => {
                        $("#channel-data").append(`<option value="${data.webservice_id}">${data.service_name}</option>`);
                    });
                },
                error: (res) => {
                    console.log(res);
        ...
        this.initDashboard = () => {
            ...
            // set widget $.ajax
            $.ajax({
                url: 'http://localhost:8000/api/company/static/' + $("#static_id").html(),
                method: 'GET',
                success: (res) => {
                    if (res.data) {
