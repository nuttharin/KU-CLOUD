import { showLoadingModal } from '../../utility.js';
...
class Customer {
    constructor() {
        ...
        let onDetailClick = (key) => {
            ...
            let phone_list = CustomerList[key].phone.map(data => {
                return data.phone_user;
            });
            $('#phone-user').html(phone_list.join(','));
            let email_list = CustomerList[key].email.map(data => {
...
import { FatoryCreateManagmentUser } from '../../ManagementUsers.js';
...
$(document).ready(function () {
    ...
    FatoryCreateManagmentUser(config);
});