    ...
    this.createEditdata = (id, myChart, full_id, type) => {
      ...
      $("#edit_chart_data_" + id).click(function () {
                          ...
                          <div class="col-5">
                            <div class="row" style="padding-top:5px; padding-bottom:5px;">
                              ...
                              <div class="col-8">
                                <ul class="nav nav-tabs" style="border-bottom:none; padding-top:5px; padding-bottom:5px;">
                                  <li><button class="btn btn-primary" data-toggle="tab" href="#daily_${id}" id="btn_daily_${id}" style="margin-right:5px;">Daily</button></li>
                                  <li><button class="btn btn-primary" data-toggle="tab" href="#monthly_${id}" id="btn_monthly_${id}" style="margin-right:5px;">Monthly</button></li>
                                  <li><button class="btn btn-primary" data-toggle="tab" href="#yearly_${id}" id="btn_yearly_${id}" style="margin-right:5px;">Yearly</button></li>
                                </ul>
                              </div>
                            </div>
                            <div class="tab-content" style="padding-top:5px; padding-bottom:5px;">
                              ...
                              <div id="yearly_${id}" class="tab-pane fade">
                                ...
                                <div class="row" style="padding-top:5px; padding-bottom:5px;">
                                  <div class="col-6">
                                    <input type="text"  id="div_start_year_${id}" class="form-control"/>
                                  </div>
                                  <div class="col-6">
                                    <input type="text"  id="div_end_year_${id}" class="form-control"/>
                                  </div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-7" id="div_preview_canvas_${id}">
                            <canvas id="preview_canvas_${id}"></canvas>
                          </div>
                      </div>
                      <hr>
                      <ul class="nav nav-tabs" style="border-bottom:none; padding-top:5px; padding-bottom:5px;">
                        <li><button class="btn btn-primary" data-toggle="tab" href="#classic_${id}" id="btn_classic_${id}" style="margin-right:5px;">Classic</button></li>
                        <li><button class="btn btn-primary" data-toggle="tab" href="#manual_${id}" id="btn_manual_${id}" style="margin-right:5px;">Manual</button></li>
                      </ul>
                      <div class="tab-content taboverflow" style="padding-top:5px; padding-bottom:5px;">
                        <div id="classic_${id}" class="tab-pane fade">  
                          <div class="row" style="padding-top:5px; padding-bottom:5px;">
                            <div class="col-6">
                              <span>Line data</span>
                        ...
                        <div id="manual_${id}" class="tab-pane fade">
                          <h3>Menu 2</h3>
        ...
        $("#save_chart_data_" + id).click(function () {
          ...
          addLabel(myChart, myChart2.data.labels);
          addDatasets(myChart, myChart2.data.datasets);
      ...
      function setDefaultData(chart)
      {
          ...
          $("#chart_data_" + id).append(`
              <div id="div_preview_chart_${id}_${i}" class="col-12">
                ...
                <div class="row" style="padding-top:5px; padding-bottom:5px;">
                  ...
                  <div class="col-1">
                    <input type="color" id="color_preview_chart_${id}_${i}" class="form-control" value="${chart.data.datasets[i].borderColor}"/>
                  </div>
                  <div class="col-1">
        ...
        $.ajax({
          url: 'http://localhost:8000/api/admin/infographic/getDatasource',
          method: 'GET',
          data: {
            info_id: infoID
          },
      ...
      function dataValueUpdata(chart, index)
      {
        return function()
        {
          ...
          if(selectValue != 0)
          {
            ...
            let keyValueList = getFlatObject(yearlyDataTest[2016]);
      ...
      function dataKeyValueUpdata(chart, index)
      {
        return function()
        {
          ...
          {
            let keyValueList = getFlatObject(yearlyDataTest);
