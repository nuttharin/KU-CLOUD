...
class Graph extends Widget {
  constructor() {
    ...
    this.createLineGraph = () => {
      ...
      console.log(new Date(2017,5,11));
      var speedData = {
        datasets: [{
          label: "Density",
          data: [
            { x: new Date(2017,5,11), y: 100 },
            { x: new Date(2019,2,21), y: 101 },],
  ...
  constructor() {
    ...
    this.createEditdata = (id, myChart, full_id, type) => {
      ...
      $("#edit_chart_data_" + id).click(function () {
                      ...
                      <div class="row"> 
                        <div class="col-12">
                          <ul class="nav nav-tabs" style="border-bottom:none; padding-top:5px; padding-bottom:5px;">
                            <li><button class="btn btn-primary" id="btn_classic_${id}" style="margin-right:5px;">Classic</button></li>
                            <li><button class="btn btn-primary" id="btn_series_${id}" style="margin-right:5px;">Time series</button></li>
                          </ul>   
                        </div>              
                      </div>
                      <hr>
        ...
        //Set up default action for classic
        ...
        //Set up default action for series
        ...
        console.log(objectPath.get(timeSeriesTest,"dataTimeSeries.0.RelativeHumidity"));
