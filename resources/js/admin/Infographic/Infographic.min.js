    ...
    this.loadWidgetData = (object, arrayService) => {
      for (var i = 0; i < object.length; i++) {
        if (object[i].type == "line" || object[i].type == "bar" || object[i].type == "pie" || object[i].type == "radar") {
          ...
          Graphwidget.loadGraphData(object[i].id, object[i].canvasTag, object[i].chartData, object[i].chartOption, object[i].type, checkStatus);
        }
...
class Graph extends Widget {
  constructor() {
    ...
    this.createLineGraph = () => {
      ...
      saveObject.WidgetGraphObject(id, null, null, null, "line", null);
    ...
    this.createBarGraph = () => {
      ...
      let saveObject = new WidgetObject();
      console.log(myChart.options);
      saveObject.WidgetGraphObject(id, null, myChart.data, myChart.options, "bar", null);
      console.log(saveObject.chartOption);
      widgetObjectList.push(saveObject);
      widgetObjectList = deepCopy(widgetObjectList);    
      console.log(widgetObjectList[0].chartOption);
    ...
    this.createPieGraph = () => {
      ...
      let saveObject = new WidgetObject();
      console.log(myChart.options);
      saveObject.WidgetGraphObject(id, null, myChart.data, myChart.options, "pie", null);
      console.log(saveObject.chartOption);
      widgetObjectList.push(saveObject);
      widgetObjectList = deepCopy(widgetObjectList);    
      console.log(widgetObjectList[0].chartOption);
    ...
    this.createRadarGraph = () => {
      ...
      let saveObject = new WidgetObject();
      console.log(myChart.options);
      saveObject.WidgetGraphObject(id, null, myChart.data, myChart.options, "radar", null);
      console.log(saveObject.chartOption);
      widgetObjectList.push(saveObject);
      widgetObjectList = deepCopy(widgetObjectList);    
      console.log(widgetObjectList[0].chartOption);
    ...
    this.loadGraphData = (id, canvasTag, chartData, chartOptions, chartType, checkStatus) => {
      this.clearfocus();
      ...
      /* Save widget */
      let saveObject = new WidgetObject();
      saveObject.WidgetGraphObject(id, null, myChart2.data, myChart2.options, chartType, null);
      widgetObjectList.push(saveObject);
      widgetObjectList = deepCopy(widgetObjectList);    
    }
  ...
  constructor() {
    ...
    this.createContext = (id, full_id, type, myChart, pathImage) => {
      ...
      $("#download_widget_" + id).click(function () {
        ...
        if(type == "table" || type == "line" || type == "bar" || type == "pie" || type == "radar")
        {
          ...
          if(myChart != null && $("#canvas_" + id).attr('state-mode') == "series")
          {
        ...
        $("#download_as_excel_" + id).click(function () {
          ...
          for (let i = 0; i < myChart.data.datasets.length; i++) {
              row +=  myChart.data.datasets[i].label + ',';
          }
          ...
          for (let i = 0; i < myChart.data.labels.length; i++) {
              ...
              row += '"' + myChart.data.labels[i].replace(/-/g,"_") + '",';

              for (let j = 0; j < myChart.data.datasets.length; j++) {
                row += '"' + myChart.data.datasets[j].data[i] + '",';
              }
    ...
    this.createEditdata = (id, myChart, full_id, type) => {
        ...
        $.ajax({
          ...
          success: (res, textStatus, xhr) => {
            ...
            listInfoDatasource.iotservice.map((data) => {
              $("optgroup[name='opt_iot']").append(`<option value="iot_${data.iotservice_id}_${data.company_id}">${data.iot_name}</option>`);
              index++;
            });

            listInfoDatasource.webservice.map((data) => {
              $("optgroup[name='opt_web']").append(`<option value="web_${data.webservice_id}_${data.company_id}">${data.service_name}</option>`);
              index++;
            });
      ...
      function setDefaultDataSeries(chart)
      {
        ...
        //   method: 'GET',
        //   data: {
        //     tableDW_name: "IoT.Input.PichetWSBeta.10",
        //   },
        //   success: (res, textStatus, xhr) => {
        //     checkAuthRes(xhr);
        ...
        $.ajax({
          ...
          success: (res, textStatus, xhr) => {
            ...
            console.log(listInfoDatasource);
            listInfoDatasource.iotservice.map((data) => {
              $("optgroup[name='opt_iot_series']").append(`<option value="iot_${data.iotservice_id}_${data.company_id}">${data.iot_name}</option>`);
              index++;
            });

            listInfoDatasource.webservice.map((data) => {
              $("optgroup[name='opt_web_series']").append(`<option value="web_${data.webservice_id}_${data.company_id}">${data.service_name}</option>`);
              index++;
            });
          ...
          else if(stateMode == "classic")
          {
            ...
            if(selectValue != 0)
            {
              ...
              else if(periodType == "yearly")
              {
                ...
                {
                  $.ajax({
                    url: END_POINT + 'infographic/getApiYearly',
                    async:false,
                    method: 'GET',
                    data: {
                      info_id: infoID
                    ...
                    success: (res, textStatus, xhr) => {
                      ...
                      let keyValueList = getFlatObject(apiList[index]["yearly"][0]);
                      ...
                      let check = 0;
                      for(let i = 0; i < apiList[index]["yearly"].length; i++)
                      {
                        for(let j = 0; j < chart.data.labels.length; j++)
                        {
                          if(apiList[index]["yearly"][i]["day"] == chart.data.labels[j])
                          {
                            check = 1;
                            break;
                          }
                        ...
                        if(check != 1)
                        {
                          yearlyLables.push(apiList[index]["yearly"][i]["day"]);
                        }
                      }

                      chart.data.labels = yearlyLables;
                      chart.update();
                    },
                    error: (res) => {
                      console.log(res);
              ...
              else if(periodType == "yearly")
              {
                ...
                if(checkInput == true)
                {
                  for(let i = 0; i < apiList[index]["yearly"].length; i++)
                  {
                    for(let j = 0; j < chart.data.labels.length; j++)
                    {
                      let dateApi = objectPath.get(apiList[index],"yearly."+ i +".day");
                      if(chart.data.labels[j] == dateApi)
                      {
                        chart.data.datasets[index].data[j] = objectPath.get(apiList[index],"yearly."+ i +"." + selectKeyValue);
                        break;
                      }
                    }
                  }
      ...
      function setDefaultData(table)
      {
        ...
        $.ajax({
          ...
          success: (res, textStatus, xhr) => {
            ...
            listInfoDatasource.iotservice.map((data) => {
              $("optgroup[name='opt_iot_table']").append(`<option value="iot_${data.iotservice_id}_${data.company_id}">${data.iot_name}</option>`);
              index++;
            });

            listInfoDatasource.webservice.map((data) => {
              $("optgroup[name='opt_web_table']").append(`<option value="web_${data.webservice_id}_${data.company_id}">${data.service_name}</option>`);
              index++;
            });
                ...
                if($("#start_daily_table_" + id).val() != "" && $("#end_daily_table_" + id).val() != "")
                {
                  $.ajax({
                    ...
                    success: (res, textStatus, xhr) => {
                      ...
                      for(let i = 0; i < apiList[index]["daily"].length; i++)
                      {
                        for(let j = 0; j < dailyLength; j++)
                        {
                          if(apiList[index]["daily"][i]["day"] == dailyLables[j])
                          {
                            check = 1;
                            break;
                          }
                ...
                if($("#start_monthly_table_" + id).val() != "" && $("#end_monthly_table_" + id).val() != "")
                {
                  $.ajax({
                    ...
                    success: (res, textStatus, xhr) => {
                      ...
                      let check = 0;
                      let monthlyLength = monthlyLables.length;

                      for(let i = 0; i < apiList[index]["monthly"].length; i++)
                      {
                        for(let j = 0; j < monthlyLength; j++)
                        {
                          if(apiList[index]["monthly"][i]["day"] == monthlyLables[j])
                          {
                            check = 1;
                            break;
                          }
                      ...
                      for(let i = 0; i < monthlyLables.length; i++)
                      {
                        if(table[0].rows[i + 1] != null)
                        {
                          $(table[0].rows[i + 1].cells[0]).html(monthlyLables[i]); 
                        }
                        else
                        {
                          let tableHtml = document.getElementById("preview_table_" + id);
                          ...
                          let cells = row.insertCell(0);
                          cells.innerHTML = monthlyLables[i];         
                ...
                if($("#start_yearly_table_" + id).val() != "" && $("#end_yearly_table_" + id).val() != "")
                {
                  $.ajax({
                    ...
                    success: (res, textStatus, xhr) => {
                      ...
                      let check = 0;
                      let yearlyLength = yearlyLables.length;

                      for(let i = 0; i < apiList[index]["yearly"].length; i++)
                      {
                        for(let j = 0; j < yearlyLength; j++)
                        {
                          if(apiList[index]["yearly"][i]["day"] == yearlyLables[j])
                          {
                            check = 1;
                            break;
                          }
                      ...
                      for(let i = 0; i < yearlyLables.length; i++)
                      {
                        if(table[0].rows[i + 1] != null)
                        {
                          $(table[0].rows[i + 1].cells[0]).html(yearlyLables[i]); 
                        }
                        else
                        {
                          let tableHtml = document.getElementById("preview_table_" + id);
                          ...
                          let cells = row.insertCell(0);
                          cells.innerHTML = yearlyLables[i];
                ...
                if(checkInput == true)
                {
                  for(let i = 0; i < apiList[index]["daily"].length; i++)
                  {
                    for(let j = 0; j < table[0].rows.length - 1; j++)
                    {
                      ...
                      {
                        $(table[0].rows[j + 1].cells[index + 1]).html(objectPath.get(apiList[index],"daily."+ i + "." + selectKeyValue));
                        break;
                      }
                    }
                  }
                ...
                if(checkInput == true)
                {
                  for(let i = 0; i < apiList[index]["monthly"].length; i++)
                  {
                    for(let j = 0; j < table[0].rows.length - 1; j++)
                    {
                      ...
                      if(table[0].rows[j + 1].cells[0].textContent == dateApi)
                      {
                        $(table[0].rows[j + 1].cells[index + 1]).html(objectPath.get(apiList[index],"monthly."+ i + "." + selectKeyValue));
                        break;
                      }
                    }
                  }
                ...
                if(checkInput == true)
                {
                  for(let i = 0; i < apiList[index]["yearly"].length; i++)
                  {
                    for(let j = 0; j < table[0].rows.length - 1; j++)
                    {
                      ...
                      if(table[0].rows[j + 1].cells[0].textContent == dateApi)
                      {
                        $(table[0].rows[j + 1].cells[index + 1]).html(objectPath.get(apiList[index],"yearly."+ i + "." + selectKeyValue));
                        break;
                      }
                    }
                  }
