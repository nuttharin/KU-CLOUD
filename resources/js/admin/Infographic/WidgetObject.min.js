...
export default class WidgetObject
{
  ...
  // Garph
  WidgetGraphObject(id, canvasTag, chartData, chartLabels, chartOption, type, serviceList)
  {
    this.id = id;
  ...
  // Table
  WidgetTableObject(id, tableTag, type, serviceList)
  {
    this.id = id;
  ...
  // Image
  WidgetImageObject(id, divImgTag, type, path)
  {
    this.id = id;
