    ...
    constructor(widget) {
                ...
                if (!this.isGroupData) {
                    ...
                    myChart.data.datasets.map(dataset => {
                        ...
                        datasource_daily.map(_data => {
                            ...
                            if (i === 0) {
                                myChart.data.labels.push(objectPath.get(_data, 'time'));
                            }
                        });
                        i++;
                    });
        ...
        this.updateData = () => {
            ...
            myChart.data.datasets.forEach((dataset) => {
                ...
                if (!this.isGroupData) {
                    dataset.data.push(objectPath.get(Datasource.getDatasources(), this.datasource[i]));
                } else {
                    dataset.data.push(objectPath.get(Datasource.getDatasources(), this.datasource.replace('[]', i)));
                }
                i++;
        ...
        this.updateTimeSeries = async () => {
            ...
            this.dateTimeSeries.map(data => {
                myChart.data.labels.push(objectPath.get(data, 'time'));
                myChart.data.datasets.forEach((dataset) => {
                    if (!this.isGroupData) {
        ...
        this.exportToExcel = () => {
            let data = [];
            console.log(this.fullChart.data)
