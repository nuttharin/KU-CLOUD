...
class ModalDetail {
    constructor() {
        ...
        this.create = (key) => {
            ...
            $('#province_detail').val(UsersList[key].address[0].pNameTh);
            $('#amphure_detail').val(UsersList[key].address[0].aNameTh);
            $('#district_detail').val(UsersList[key].address[0].dNameTh);
            $('#zip_code_detail').val(UsersList[key].address[0].zip_code);
