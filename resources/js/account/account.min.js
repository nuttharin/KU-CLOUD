...
class Account {
    constructor() {
        ...
        let bindElement = () => {
            ...
            addEventValidate(validateInput.updateUsername);
        ...
        let updateUsername = () => {
            if(checkError(validateInput.updateName)) return;
            ...
            $.ajax({
                ...
                error: (res) => {
                    ...
                    if(errors.username){
                        showErrorsForInputCustom($("input[name='username']"),errors.username[0])
                    }
        ...
        let addEmail = () => {
            ...
            $.ajax({
                ...
                error: (res) => {
                    let errors = res.responseJSON.errors;
                    if(errors.email){
                        showErrorsForInputCustom($("input[name='add-email']"),errors.email[0]);
                    }
                }
            });
        };
        ...
        let addPhone = () => {
            ...
            $.ajax({
                ...
                error: (res) => {
                    let errors = res.responseJSON.errors;
                    if(errors.phone){
                        showErrorsForInputCustom( $("input[name='add-phone']"),errors.phone[0]);
                    }
                }
            });
        };
