...
@section('title','Admin | Users-Administer') 
@section('content')
    ...
    <div class="card-header bg-white">
        <div class="row">
            <div class="col-6" style="padding: 30px 0px 10px 15px">
                <span class="h3">Users Administer</span>
            </div>
...
<div class="row" style="padding: 30px 0px 10px 0px">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table style="width: 100%; display:none" class="table table-striped table-bordered table-hover dt-responsive nowrap" id="datatable-admin">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Email</th>
...
<script type="text/javascript" src="{{url('js/admin/Users/UsersAdminister.js')}}"></script>
