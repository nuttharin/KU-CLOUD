...
@section('title','Add WebService | Admin')
@section('content')
<?php
        ...
        <div class="col-sm-8 " >
            <div class ="row">
                <div class="col-sm-8">
                    ...
                    <input type="text" class="mb-2" id="name-webservice" name="name" placeholder="Webservice name" require>
                </div>
                <div class="col-sm-4">
                    <h6 >Alias <span style="color:red">*</span></h6>
                    <input type="text" class="mb-2" id="alias-webservice" name="alias" placeholder="Webservice alias " require>
                </div>
            </div>
            ...
            <button type="button" id="btn-showvalue" class="btn btn-primary show-header"><a href="#select">Show value</a></button>  
...
<script type="text/javascript" src="{{url('js/admin/services/addservice.js')}}"></script>
