        ...
        <div class="row" style="margin-top:30px;">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table style="width: 100% ;display: none" class="table table-striped table-bordered table-hover"
                            id="table-file-log">
                            <thead>
                                <th>File</th>
                                <th>Size</th>
        ...
        <div class="card bg-white" style="margin-top:30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <div class="mr-auto">
                            ...
                            <button class="btn btn-danger btn-radius" id="btn_delete_file"><i
            ...
            <div class="card-body">
                    <table style="width: 100% ;display: none"
                        class="table table-striped table-bordered table-hover dt-responsive nowrap" id="table-log">
                        <thead>
                            <tr>
                                <th>Level</th>
                                <th>Date</th>
...
<script type="text/javascript" src="{{url('js/company/Logs/databaseLogs.min.js')}}"></script>
@endsection
