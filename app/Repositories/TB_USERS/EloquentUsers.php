...
class EloquentUsers implements UsersRepository
{
    ...
    public function getByTypeForAdmin($type)
    {
        ...
        if ($type == "ADMIN") {
            ...
            $address_user = DB::select('SELECT address_users.user_id, address_users.address_detail, address_users.district_id, address_users.amphure_id, address_users.province_id,
